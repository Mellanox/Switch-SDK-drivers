...
enum ku_ctrl_cmd {
    ...
    CTRL_CMD_GET_SECURE_FW_BOOT_STATUS,
    CTRL_CMD_GET_DEV_INFO,
    CTRL_CMD_MIN_VAL = CTRL_CMD_GET_CAPABILITIES, /**< Minimum enum value */
    CTRL_CMD_MAX_VAL = CTRL_CMD_GET_DEV_INFO, /**< Maximum enum value */
...
#include "auto_registers/kernel_cmd_access_auto.h"
    ...
    CTRL_CMD_ACCESS_REG_MAX = CTRL_CMD_ACCESS_REG_RDPM  /**< Maximum enum value */
};
...
enum sxd_secure_fw_boot_status_e {
    SXD_SECURE_FW_BOOT_STATUS_OK_E,
    SXD_SECURE_FW_BOOT_STATUS_SPC4_IN_FLASH_RECOVERY_E,
    SXD_SECURE_FW_BOOT_STATUS_SPC4_RMA_E
};

struct ku_secure_fw_boot_status {
    uint8_t                          dev_id;
    enum sxd_secure_fw_boot_status_e boot_status;
};
...
struct ku_mpat_reg {
    ...
    uint8_t                              itc; /**< Ignore Truncation Configuration */
...
struct ku_dev_info {
    uint8_t               dev_id;   /**< dev_id - device id */
    struct sx_device_info dev_info; /**< dev_info - device information */
};
