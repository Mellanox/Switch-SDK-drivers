...
#define SXD_FOREACH_OBJECT_HEALTH_CASUE(SXD_HEALTH_TYPE)                                             \
    ...
    SXD_HEALTH_TYPE(SXD_HEALTH_CAUSE_SILVER_IRISC, , "Silver irisc not responding as expected")      \
...
enum sxd_thread_severity_e {
    SXD_THREAD_SEVERITY_FATAL_E,
    SXD_THREAD_SEVERITY_ERR_E,
    SXD_THREAD_SEVERITY_WARNING_E,
    SXD_THREAD_SEVERITY_MAX_E = SXD_THREAD_SEVERITY_WARNING_E
};
