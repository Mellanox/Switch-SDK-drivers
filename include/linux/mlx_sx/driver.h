...
enum sx_dev_event {
    ...
    SX_DEV_EVENT_PCI_SHUTDOWN,
    SX_DEV_EVENT_PCI_PRE_RESTART,
    SX_DEV_EVENT_PCI_POST_RESTART
};
...
int sx_core_remove_synd(u8 swid, u16 hw_synd, enum l2_type type, u8 is_default,
                        ...
                        const struct ku_port_vlan_params *port_vlan, u8 is_register); /* is_register ==> 1=register, 0=filter. */
