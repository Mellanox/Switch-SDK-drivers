...
typedef enum sxd_paos_ps_e {
    ...
    SXD_PAOS_PS_E_MAX = SXD_PAOS_PS_E_LINKUP_E
} sxd_paos_ps_e_t;
...
typedef enum sxd_pmmp_eeprom_override {
    ...
    SXD_PMMP_EEPROM_OVERRIDE_MAX = SXD_PMMP_EEPROM_OVERRIDE_COMPLIANCE_CODE_IGNORE_E
...
typedef enum sxd_pddr_neg_mode_active {
    ...
    SXD_PDDR_NEG_MODE_ACTIVE_MAX = SXD_PDDR_NEG_MODE_ACTIVE_NLPN_REV2_NEGOTIATED_E
