...
/**
 * ku_sbme_reg structure is used to store the SBME register parameters
 */
struct ku_sbme_reg {
    uint8_t desc;
    uint8_t local_port;
...
/**
 * ku_access_sbme_reg structure is used to store the access register SBME command parameters
 */
struct ku_access_sbme_reg {
    struct ku_operation_tlv op_tlv; /**< op_tlv - operation tlv struct */
    struct ku_sbme_reg      sbme_reg; /**< sbme_reg - sbme register tlv */
    uint8_t                 dev_id; /**< dev_id - device id */
};
