...
uint8_t mlxsw_reg_slsir_bkv_revision_get(const char *buf);
 ...
 *
 */
#define MLXSW_SBME_ID 0xb00e
#define MLXSW_SBME_LEN 0x28

uint8_t mlxsw_reg_sbme_desc_get(const char *buf);

void mlxsw_reg_sbme_desc_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_sbme_local_port_get(const char *buf);

void mlxsw_reg_sbme_local_port_set(char *buf, uint8_t val);

uint8_t mlxsw_reg_sbme_pool_get(const char *buf);

void mlxsw_reg_sbme_pool_set(char *buf, uint8_t val);
