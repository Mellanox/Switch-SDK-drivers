...
uint64_t mlxsw_reg_mcqi_build_time_get(const char *buf);

void mlxsw_reg_mcqi_build_time_set(char *buf, uint64_t val);

uint64_t mlxsw_reg_mcqi_user_defined_time_get(const char *buf);

void mlxsw_reg_mcqi_user_defined_time_set(char *buf, uint64_t val);
...
uint32_t mlxsw_reg_ptys_ext_eth_proto_lp_advertise_get(const char *buf);
...
void mlxsw_reg_ppcnt_qp1_dropped_set(char *buf, uint16_t val);
...
uint32_t mlxsw_reg_ppcnt_plr_rcv_codes_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_rcv_codes_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_rcv_code_err_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_rcv_code_err_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_rcv_uncorrectable_code_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_rcv_uncorrectable_code_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_xmit_codes_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_xmit_codes_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_xmit_retry_codes_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_xmit_retry_codes_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_xmit_retry_events_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_xmit_retry_events_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_sync_events_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_sync_events_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_codes_loss_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_codes_loss_low_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_xmit_retry_events_within_t_sec_max_high_get(const char *buf);

uint32_t mlxsw_reg_ppcnt_plr_xmit_retry_events_within_t_sec_max_low_get(const char *buf);
...
uint8_t mlxsw_reg_pmcr_agc_bw_value_get(const char *buf);

void mlxsw_reg_pmcr_agc_bw_value_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_slsir_uphy_rev_subminor_get(const char *buf);

uint8_t mlxsw_reg_slsir_bkv_revision_cln_get(const char *buf);

uint8_t mlxsw_reg_slsir_bkv_revision_rx_get(const char *buf);

uint8_t mlxsw_reg_slsir_uphy_rev_major_get(const char *buf);

uint8_t mlxsw_reg_slsir_uphy_rev_minor_get(const char *buf);
...
uint8_t mlxsw_reg_pddr_rtt_measure_valid_get(const char *buf);
...
uint32_t mlxsw_reg_pddr_rtt_measured_get(const char *buf);
...
uint16_t mlxsw_reg_pddr_kr_startup_debug_indications_get(const char *buf, unsigned short outer_index, unsigned short index);

uint8_t mlxsw_reg_pddr_tx_tuning_stages_lane0_get(const char *buf);

uint8_t mlxsw_reg_pddr_tx_tuning_stages_lane1_get(const char *buf);

uint8_t mlxsw_reg_pddr_tx_tuning_stages_lane2_get(const char *buf);

uint8_t mlxsw_reg_pddr_tx_tuning_stages_lane3_get(const char *buf);
...
uint32_t mlxsw_reg_pddr_vendor_name_get(const char *buf, unsigned short outer_index, unsigned short index);

uint32_t mlxsw_reg_pddr_vendor_pn_get(const char *buf, unsigned short outer_index, unsigned short index);

uint32_t mlxsw_reg_pddr_vendor_rev_get(const char *buf);

uint32_t mlxsw_reg_pddr_fw_version_get(const char *buf);

uint32_t mlxsw_reg_pddr_vendor_sn_get(const char *buf, unsigned short outer_index, unsigned short index);
...
uint8_t mlxsw_reg_pddr_last_ber_mantissa_get(const char *buf);

uint8_t mlxsw_reg_pddr_last_ber_exp_get(const char *buf);

uint8_t mlxsw_reg_pddr_ber_mantissa_get(const char *buf);

uint8_t mlxsw_reg_pddr_ber_exp_get(const char *buf);

uint8_t mlxsw_reg_pddr_min_ber_mantissa_get(const char *buf);

uint8_t mlxsw_reg_pddr_min_ber_exp_get(const char *buf);

uint8_t mlxsw_reg_pddr_max_ber_mantissa_get(const char *buf);

uint8_t mlxsw_reg_pddr_max_ber_exp_get(const char *buf);

uint16_t mlxsw_reg_pddr_num_of_ber_alarams_get(const char *buf);
...
uint8_t mlxsw_reg_pddr_buff_sel_get(const char *buf);

void mlxsw_reg_pddr_buff_sel_set(char *buf, uint8_t val);
...
uint8_t mlxsw_reg_pptt_sk_rxd_get(const char *buf);

void mlxsw_reg_pptt_sk_rxd_set(char *buf, uint8_t val);
...
void mlxsw_reg_ratrb_destination_mac_memcpy_from(const char *buf, unsigned short index, char *dst);

void mlxsw_reg_ratrb_destination_mac_memcpy_to(char *buf, unsigned short index, const char *src);
...
uint32_t mlxsw_reg_upbt_utcam_key_id_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_upbt_utcam_key_id_set(char *buf, unsigned short outer_index, unsigned short index, uint32_t val);
...
void mlxsw_reg_usak_sa_key_set(char *buf, unsigned short outer_index, unsigned short index, uint32_t val);
...
uint32_t mlxsw_reg_uter_entry_get(const char *buf, unsigned short outer_index, unsigned short index);

void mlxsw_reg_uter_entry_set(char *buf, unsigned short outer_index, unsigned short index, uint32_t val);
