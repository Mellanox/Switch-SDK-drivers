...
int __PMPT_decode(u8 *inbox, void *ku_reg, void *context);
...
int __PMPD_decode(u8 *inbox, void *ku_reg, void *context);
...
int __PPTT_decode(u8 *inbox, void *ku_reg, void *context);
...
int __PPRT_decode(u8 *inbox, void *ku_reg, void *context);
...
int __PPRR_decode(u8 *inbox, void *ku_reg, void *context);
