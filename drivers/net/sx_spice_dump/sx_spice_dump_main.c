...
int sx_spice_sxd_access(dev_private_data_t *priv_data, sxd_params_t *params, void * reg_data)
{
    ...
    case MLXSW_PDDR_ID:
        ...
        if (err || (((struct ku_access_pddr_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_DEBUG "SPICE: sx_ACCESS_REG_PDDR failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_PPCNT_ID:
        ...
        if (err || (((struct ku_access_ppcnt_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_DEBUG "SPICE: sx_ACCESS_REG_PPCNT failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_PMDR_ID:
        ...
        if (err || (((struct ku_access_pmdr_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_DEBUG "SPICE: sx_ACCESS_REG_PMDR failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_PTYS_ID:
        ...
        if (err || (((struct ku_access_ptys_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_DEBUG "SPICE: sx_ACCESS_REG_PTYS failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_MSGI_ID:
        ...
        if (err || (((struct ku_access_msgi_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_DEBUG "SPICE: sx_ACCESS_REG_MSGI failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_MGIR_ID:
        ...
        if (err || (((struct ku_access_mgir_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_DEBUG "SPICE: sx_ACCESS_REG_MGIR failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_MDIR_ID:
        ...
        if (err || (((struct ku_access_mdir_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_DEBUG "SPICE: sx_ACCESS_REG_MDIR failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_MVCAP_ID:
        ...
        if (err || (((struct ku_access_mvcap_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_DEBUG "SPICE: sx_ACCESS_REG_MVCAP failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_SLTP_ID:
        ...
        if (err || (((struct ku_access_sltp_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_DEBUG "SPICE: sx_ACCESS_REG_SLTP failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_SLLM_ID:
        ...
        if (err || (((struct ku_access_sllm_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_DEBUG "SPICE: sx_ACCESS_REG_SLLM failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_SPAD_ID:
        ...
        if (err || (((struct ku_access_spad_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_DEBUG "SPICE: sx_ACCESS_REG_SPAD failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_SPZR_ID:
        ...
        if (err || (((struct ku_access_spzr_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_DEBUG "SPICE: sx_ACCESS_REG_SPZR failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_MTCAP_ID:
        ...
        if (err || (((struct ku_access_mtcap_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_DEBUG "SPICE: sx_ACCESS_REG_MTCAP failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_SLRIP_ID:
        ...
        if (err || (((struct ku_access_slrip_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_DEBUG "SPICE: sx_ACCESS_REG_SLRIP failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_SLRG_ID:
        ...
        if (err || (((struct ku_access_slrg_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_ERR "SPICE: sx_ACCESS_REG_SLRG failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_PPHCR_ID:
        ...
        if (err || (((struct ku_access_pphcr_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_ERR "SPICE: sx_ACCESS_REG_PPHCR failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_MTMP_ID:
        ...
        if (err || (((struct ku_access_mtmp_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_DEBUG "SPICE: sx_ACCESS_REG_MTMP failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
    ...
    case MLXSW_SLRP_ID:
        ...
        if (err || (((struct ku_access_slrp_reg *)reg_data)->op_tlv.status)) {
            printk(KERN_DEBUG "SPICE: sx_ACCESS_REG_SLRP failed with err: %d\n", err);
            err = -EINVAL;
            goto out;
        }
