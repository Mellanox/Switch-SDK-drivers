...
static const char * sx_drop_monitor_trap_str(struct completion_info *ci)
{
    if ((ci->hw_synd >= SXD_TRAP_ID_MIRROR_AGENT0) &&
        ...
        case SXD_ACL_DIRECTION_INGRESS_E:
        case SXD_ACL_DIRECTION_RIF_INGRESS_E:
        case SXD_ACL_DIRECTION_TPORT_INGRESS_E:
            return "ingress_flow_action_drop";

        case SXD_ACL_DIRECTION_EGRESS_E:
        case SXD_ACL_DIRECTION_RIF_EGRESS_E:
        case SXD_ACL_DIRECTION_TPORT_EGRESS_E:
            return "egress_flow_action_drop";

        case SXD_ACL_DIRECTION_MULTI_POINTS_E:
