...
static void sx_fw_2_ku_query_fw(const struct sx_fw *fw, struct ku_query_fw *query_fw)
{
...
#define QUERY_FW_SIZE_OFFSET           0x00
    ...
    if (NULL != query_fw) {
        sx_fw_2_ku_query_fw(&fw, query_fw);
    }
    ...
    if ((!priv->is_fw_initialized) &&
        ...
        sx_fw_2_ku_query_fw(&fw, &priv->dev_info.q_fw);
