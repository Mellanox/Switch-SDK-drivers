 ...
 * Functions
 ***********************************************/
static void __sx_af_dbg_info_ts_dump(struct seq_file *m, void *v, ktime_t *ktime_p);
...
static int __sx_af_dbg_info_mafbi_record_dump(struct seq_file *m, void *v, cbuf_record_t *record_p);
static int __sx_af_dbg_info_mafti_record_dump(struct seq_file *m, void *v, cbuf_record_t *record_p);
static int __sx_af_dbg_info_mocs_record_dump(struct seq_file *m, void *v, cbuf_record_t *record_p);
static int __sx_af_dbg_info_record_dump(struct seq_file *m, void *v, cbuf_record_t *record_p);
static int __sx_af_dbg_info_records_dump(struct seq_file *m, void *v, af_dbg_db_t *db_p);
static int __sx_af_dbg_info_dump(struct seq_file *m, void *v, af_dbg_db_t *db_p);
...
static int __sx_af_dbg_info_record_dump(struct seq_file *m, void *v, cbuf_record_t *record_p)
{
    ...
    __sx_af_dbg_info_ts_dump(m, v, &record_p->ts);
    ...
    case CBUF_RECORD_TYPE_MAFBI_E:
        __sx_af_dbg_info_mafbi_record_dump(m, v, record_p);
        break;

    case CBUF_RECORD_TYPE_MAFTI_E:
        __sx_af_dbg_info_mafti_record_dump(m, v, record_p);
        break;

    case CBUF_RECORD_TYPE_MOCS_E:
        __sx_af_dbg_info_mocs_record_dump(m, v, record_p);
        break;
...
static int __sx_af_dbg_info_records_dump(struct seq_file *m, void *v, af_dbg_db_t *db_p)
{
    ...
    do {
        ...
        __sx_af_dbg_info_record_dump(m, v, record_p);
    } while (count);
...
static int __sx_af_dbg_info_dump(struct seq_file *m, void *v, af_dbg_db_t *db_p)
{
    ...
    __sx_af_dbg_info_records_dump(m, v, db_p);

    return 0;
}

int sx_af_dbg_info_dump(struct seq_file *m, void *v)
{
    int          err = 0;
    ...
    err = __sx_af_dbg_info_dump(m, v, db_clone_p);
