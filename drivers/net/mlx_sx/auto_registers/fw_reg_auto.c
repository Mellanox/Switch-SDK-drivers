...
int __MTWE_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    for (i = 0; i < SXD_MTWE_SENSOR_WARNING_NUM; i++) {
        mtwe_reg->sensor_warning[i] = mlxsw_reg_mtwe_sensor_warning_get(outbox, 0, i);
    }
...
int __MTEWE_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    for (i = 0; i < SXD_MTEWE_SENSOR_WARNING_NUM; i++) {
        mtewe_reg->sensor_warning[i] = mlxsw_reg_mtewe_sensor_warning_get(outbox, 0, i);
    }
...
int __MCQI_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    case SXD_MCQI_INFO_TYPE_CAPABILITIES_E:
        mlxsw_reg_mcqi_signed_updates_only_set(inbox, mcqi_reg->data.mcqi_cap.signed_updates_only);
        mlxsw_reg_mcqi_match_chip_id_set(inbox, mcqi_reg->data.mcqi_cap.match_chip_id);
        mlxsw_reg_mcqi_match_psid_set(inbox, mcqi_reg->data.mcqi_cap.match_psid);
        mlxsw_reg_mcqi_check_user_timestamp_set(inbox, mcqi_reg->data.mcqi_cap.check_user_timestamp);
        mlxsw_reg_mcqi_match_base_guid_mac_set(inbox, mcqi_reg->data.mcqi_cap.match_base_guid_mac);
        break;

    case SXD_MCQI_INFO_TYPE_VERSION_E:
        mlxsw_reg_mcqi_build_time_valid_set(inbox, mcqi_reg->data.mcqi_version.build_time_valid);
        mlxsw_reg_mcqi_user_defined_time_valid_set(inbox, mcqi_reg->data.mcqi_version.user_defined_time_valid);
        mlxsw_reg_mcqi_version_string_length_set(inbox, mcqi_reg->data.mcqi_version.version_string_length);
        mlxsw_reg_mcqi_version_set(inbox, mcqi_reg->data.mcqi_version.version);
        mlxsw_reg_mcqi_build_time_set(inbox, mcqi_reg->data.mcqi_version.build_time);
        mlxsw_reg_mcqi_user_defined_time_set(inbox, mcqi_reg->data.mcqi_version.user_defined_time);
        mlxsw_reg_mcqi_build_tool_version_set(inbox, mcqi_reg->data.mcqi_version.build_tool_version);
        mlxsw_reg_mcqi_version_string_memcpy_to(inbox, (char *)mcqi_reg->data.mcqi_version.version_string);
        break;
...
int __MCQI_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    switch (mcqi_reg->info_type) {
    case SXD_MCQI_INFO_TYPE_CAPABILITIES_E:
        mcqi_reg->data.mcqi_cap.supported_info_bitmask = mlxsw_reg_mcqi_supported_info_bitmask_get(outbox);
        mcqi_reg->data.mcqi_cap.component_size = mlxsw_reg_mcqi_component_size_get(outbox);
        mcqi_reg->data.mcqi_cap.max_component_size = mlxsw_reg_mcqi_max_component_size_get(outbox);
        mcqi_reg->data.mcqi_cap.log_mcda_word_size = mlxsw_reg_mcqi_log_mcda_word_size_get(outbox);
        mcqi_reg->data.mcqi_cap.mcda_max_write_size = mlxsw_reg_mcqi_mcda_max_write_size_get(outbox);
        mcqi_reg->data.mcqi_cap.rd_en = mlxsw_reg_mcqi_rd_en_get(outbox);
        mcqi_reg->data.mcqi_cap.signed_updates_only = mlxsw_reg_mcqi_signed_updates_only_get(outbox);
        mcqi_reg->data.mcqi_cap.match_chip_id = mlxsw_reg_mcqi_match_chip_id_get(outbox);
        mcqi_reg->data.mcqi_cap.match_psid = mlxsw_reg_mcqi_match_psid_get(outbox);
        mcqi_reg->data.mcqi_cap.check_user_timestamp = mlxsw_reg_mcqi_check_user_timestamp_get(outbox);
        mcqi_reg->data.mcqi_cap.match_base_guid_mac = mlxsw_reg_mcqi_match_base_guid_mac_get(outbox);
        break;

    case SXD_MCQI_INFO_TYPE_VERSION_E:
        mcqi_reg->data.mcqi_version.build_time_valid = mlxsw_reg_mcqi_build_time_valid_get(outbox);
        mcqi_reg->data.mcqi_version.user_defined_time_valid = mlxsw_reg_mcqi_user_defined_time_valid_get(outbox);
        mcqi_reg->data.mcqi_version.version_string_length = mlxsw_reg_mcqi_version_string_length_get(outbox);
        mcqi_reg->data.mcqi_version.version = mlxsw_reg_mcqi_version_get(outbox);
        mcqi_reg->data.mcqi_version.build_time = mlxsw_reg_mcqi_build_time_get(outbox);
        mcqi_reg->data.mcqi_version.user_defined_time = mlxsw_reg_mcqi_user_defined_time_get(outbox);
        mcqi_reg->data.mcqi_version.build_tool_version = mlxsw_reg_mcqi_build_tool_version_get(outbox);
        mlxsw_reg_mcqi_version_string_memcpy_from(outbox, (char *)mcqi_reg->data.mcqi_version.version_string);
        break;

    case SXD_MCQI_INFO_TYPE_ACTIVATION_METHOD_E:
        mcqi_reg->data.mcqi_activation_method.self_activation = mlxsw_reg_mcqi_self_activation_get(outbox);
        mcqi_reg->data.mcqi_activation_method.pending_server_ac_power_cycle = mlxsw_reg_mcqi_pending_server_ac_power_cycle_get(outbox);
        mcqi_reg->data.mcqi_activation_method.pending_server_dc_power_cycle = mlxsw_reg_mcqi_pending_server_dc_power_cycle_get(outbox);
        mcqi_reg->data.mcqi_activation_method.pending_server_reboot = mlxsw_reg_mcqi_pending_server_reboot_get(outbox);
        mcqi_reg->data.mcqi_activation_method.pending_fw_reset = mlxsw_reg_mcqi_pending_fw_reset_get(outbox);
        mcqi_reg->data.mcqi_activation_method.auto_activate = mlxsw_reg_mcqi_auto_activate_get(outbox);
        mcqi_reg->data.mcqi_activation_method.all_hosts_sync = mlxsw_reg_mcqi_all_hosts_sync_get(outbox);
        break;

    case SXD_MCQI_INFO_TYPE_LINKX_PROPERTIES_E:
        mcqi_reg->data.mcqi_linkx_properties.fw_image_info_bitmap = mlxsw_reg_mcqi_fw_image_info_bitmap_get(outbox);
        mcqi_reg->data.mcqi_linkx_properties.fw_image_status_bitmap = mlxsw_reg_mcqi_fw_image_status_bitmap_get(outbox);
        mcqi_reg->data.mcqi_linkx_properties.image_a_major = mlxsw_reg_mcqi_image_a_major_get(outbox);
        mcqi_reg->data.mcqi_linkx_properties.image_a_minor = mlxsw_reg_mcqi_image_a_minor_get(outbox);
        mcqi_reg->data.mcqi_linkx_properties.image_a_subminor = mlxsw_reg_mcqi_image_a_subminor_get(outbox);
        mcqi_reg->data.mcqi_linkx_properties.image_b_major = mlxsw_reg_mcqi_image_b_major_get(outbox);
        mcqi_reg->data.mcqi_linkx_properties.image_b_minor = mlxsw_reg_mcqi_image_b_minor_get(outbox);
        mcqi_reg->data.mcqi_linkx_properties.image_b_subminor = mlxsw_reg_mcqi_image_b_subminor_get(outbox);
        mcqi_reg->data.mcqi_linkx_properties.factory_image_major = mlxsw_reg_mcqi_factory_image_major_get(outbox);
        mcqi_reg->data.mcqi_linkx_properties.factory_image_minor = mlxsw_reg_mcqi_factory_image_minor_get(outbox);
        mcqi_reg->data.mcqi_linkx_properties.factory_image_subminor = mlxsw_reg_mcqi_factory_image_subminor_get(outbox);
        mcqi_reg->data.mcqi_linkx_properties.activation_type = mlxsw_reg_mcqi_activation_type_get(outbox);
        mcqi_reg->data.mcqi_linkx_properties.management_interface_protocol = mlxsw_reg_mcqi_management_interface_protocol_get(outbox);
        mcqi_reg->data.mcqi_linkx_properties.vendor_sn = mlxsw_reg_mcqi_vendor_sn_get(outbox);
        break;
...
int __MCDA_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    for (i = 0; i < SXD_MCDA_DATA_NUM; i++) {
        mlxsw_reg_mcda_data_set(inbox, 0, i, mcda_reg->data[i]);
    }
...
int __MCDA_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    for (i = 0; i < SXD_MCDA_DATA_NUM; i++) {
        mcda_reg->data[i] = mlxsw_reg_mcda_data_get(outbox, 0, i);
    }
...
int __PTYS_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    ptys_reg->ext_eth_proto_lp_advertise = mlxsw_reg_ptys_ext_eth_proto_lp_advertise_get(outbox);
...
int __PPCNT_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    case SXD_PPCNT_GRP_PLR_COUNTERS_GROUP_E:
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_rcv_codes_high = mlxsw_reg_ppcnt_plr_rcv_codes_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_rcv_codes_low = mlxsw_reg_ppcnt_plr_rcv_codes_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_rcv_code_err_high = mlxsw_reg_ppcnt_plr_rcv_code_err_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_rcv_code_err_low = mlxsw_reg_ppcnt_plr_rcv_code_err_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_rcv_uncorrectable_code_high = mlxsw_reg_ppcnt_plr_rcv_uncorrectable_code_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_rcv_uncorrectable_code_low = mlxsw_reg_ppcnt_plr_rcv_uncorrectable_code_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_xmit_codes_high = mlxsw_reg_ppcnt_plr_xmit_codes_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_xmit_codes_low = mlxsw_reg_ppcnt_plr_xmit_codes_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_xmit_retry_codes_high = mlxsw_reg_ppcnt_plr_xmit_retry_codes_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_xmit_retry_codes_low = mlxsw_reg_ppcnt_plr_xmit_retry_codes_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_xmit_retry_events_high = mlxsw_reg_ppcnt_plr_xmit_retry_events_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_xmit_retry_events_low = mlxsw_reg_ppcnt_plr_xmit_retry_events_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_sync_events_high = mlxsw_reg_ppcnt_plr_sync_events_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_sync_events_low = mlxsw_reg_ppcnt_plr_sync_events_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_codes_loss_high = mlxsw_reg_ppcnt_plr_codes_loss_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_codes_loss_low = mlxsw_reg_ppcnt_plr_codes_loss_low_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_xmit_retry_events_within_t_sec_max_high = mlxsw_reg_ppcnt_plr_xmit_retry_events_within_t_sec_max_high_get(outbox);
        ppcnt_reg->counter_set.ppcnt_plr_counters.plr_xmit_retry_events_within_t_sec_max_low = mlxsw_reg_ppcnt_plr_xmit_retry_events_within_t_sec_max_low_get(outbox);
        break;
...
* PMPT
***********************************************/
int __PMPT_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_pmpt_reg *pmpt_reg = (struct ku_pmpt_reg*)ku_reg;

    mlxsw_reg_pmpt_e_set(inbox, pmpt_reg->e);
    mlxsw_reg_pmpt_le_set(inbox, pmpt_reg->le);
    mlxsw_reg_pmpt_slot_index_set(inbox, pmpt_reg->slot_index);
    mlxsw_reg_pmpt_module_set(inbox, pmpt_reg->module);
    mlxsw_reg_pmpt_host_media_set(inbox, pmpt_reg->host_media);
    mlxsw_reg_pmpt_lane_mask_set(inbox, pmpt_reg->lane_mask);
    mlxsw_reg_pmpt_prbs_mode_admin_set(inbox, pmpt_reg->prbs_mode_admin);
    mlxsw_reg_pmpt_swap_admin_set(inbox, pmpt_reg->swap_admin);
    mlxsw_reg_pmpt_invt_admin_set(inbox, pmpt_reg->invt_admin);
    mlxsw_reg_pmpt_ch_ge_set(inbox, pmpt_reg->ch_ge);
    mlxsw_reg_pmpt_modulation_set(inbox, pmpt_reg->modulation);
    mlxsw_reg_pmpt_lane_rate_admin_set(inbox, pmpt_reg->lane_rate_admin);


    return 0;
}

int __PMPT_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_pmpt_reg *pmpt_reg = (struct ku_pmpt_reg*)ku_reg;

    pmpt_reg->e = mlxsw_reg_pmpt_e_get(outbox);
    pmpt_reg->ls = mlxsw_reg_pmpt_ls_get(outbox);
    pmpt_reg->le = mlxsw_reg_pmpt_le_get(outbox);
    pmpt_reg->slot_index = mlxsw_reg_pmpt_slot_index_get(outbox);
    pmpt_reg->module = mlxsw_reg_pmpt_module_get(outbox);
    pmpt_reg->swap_cap = mlxsw_reg_pmpt_swap_cap_get(outbox);
    pmpt_reg->invt_cap = mlxsw_reg_pmpt_invt_cap_get(outbox);
    pmpt_reg->host_media = mlxsw_reg_pmpt_host_media_get(outbox);
    pmpt_reg->lane_mask = mlxsw_reg_pmpt_lane_mask_get(outbox);
    pmpt_reg->status = mlxsw_reg_pmpt_status_get(outbox);
    pmpt_reg->prbs_modes_cap = mlxsw_reg_pmpt_prbs_modes_cap_get(outbox);
    pmpt_reg->prbs_mode_admin = mlxsw_reg_pmpt_prbs_mode_admin_get(outbox);
    pmpt_reg->swap_admin = mlxsw_reg_pmpt_swap_admin_get(outbox);
    pmpt_reg->invt_admin = mlxsw_reg_pmpt_invt_admin_get(outbox);
    pmpt_reg->ch_ge = mlxsw_reg_pmpt_ch_ge_get(outbox);
    pmpt_reg->modulation = mlxsw_reg_pmpt_modulation_get(outbox);
    pmpt_reg->lane_rate_cap = mlxsw_reg_pmpt_lane_rate_cap_get(outbox);
    pmpt_reg->lane_rate_admin = mlxsw_reg_pmpt_lane_rate_admin_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__PMPT_decode);

int sx_ACCESS_REG_PMPT(struct sx_dev *dev, struct ku_access_pmpt_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_PMPT_LEN >> 2) + 1;

    if (MLXSW_PMPT_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_PMPT);

int sx_EMAD_ACCESS_REG_PMPT(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_PMPT);

/************************************************
* PMPD
***********************************************/
int __PMPD_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_pmpd_reg *pmpd_reg = (struct ku_pmpd_reg*)ku_reg;

    mlxsw_reg_pmpd_slot_index_set(inbox, pmpd_reg->slot_index);
    mlxsw_reg_pmpd_module_set(inbox, pmpd_reg->module);
    mlxsw_reg_pmpd_host_media_set(inbox, pmpd_reg->host_media);
    mlxsw_reg_pmpd_lane_set(inbox, pmpd_reg->lane);
    mlxsw_reg_pmpd_cl_set(inbox, pmpd_reg->cl);


    return 0;
}

int __PMPD_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_pmpd_reg *pmpd_reg = (struct ku_pmpd_reg*)ku_reg;

    pmpd_reg->snr_cap = mlxsw_reg_pmpd_snr_cap_get(outbox);
    pmpd_reg->ber_cap = mlxsw_reg_pmpd_ber_cap_get(outbox);
    pmpd_reg->errors_cap = mlxsw_reg_pmpd_errors_cap_get(outbox);
    pmpd_reg->slot_index = mlxsw_reg_pmpd_slot_index_get(outbox);
    pmpd_reg->module = mlxsw_reg_pmpd_module_get(outbox);
    pmpd_reg->host_media = mlxsw_reg_pmpd_host_media_get(outbox);
    pmpd_reg->lane = mlxsw_reg_pmpd_lane_get(outbox);
    pmpd_reg->cl = mlxsw_reg_pmpd_cl_get(outbox);
    pmpd_reg->status = mlxsw_reg_pmpd_status_get(outbox);
    pmpd_reg->prbs_bits_high = mlxsw_reg_pmpd_prbs_bits_high_get(outbox);
    pmpd_reg->prbs_bits_low = mlxsw_reg_pmpd_prbs_bits_low_get(outbox);
    pmpd_reg->prbs_errors_high = mlxsw_reg_pmpd_prbs_errors_high_get(outbox);
    pmpd_reg->prbs_errors_low = mlxsw_reg_pmpd_prbs_errors_low_get(outbox);
    pmpd_reg->measured_snr = mlxsw_reg_pmpd_measured_snr_get(outbox);
    pmpd_reg->ber_magnitude = mlxsw_reg_pmpd_ber_magnitude_get(outbox);
    pmpd_reg->ber_coef = mlxsw_reg_pmpd_ber_coef_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__PMPD_decode);

int sx_ACCESS_REG_PMPD(struct sx_dev *dev, struct ku_access_pmpd_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_PMPD_LEN >> 2) + 1;

    if (MLXSW_PMPD_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_PMPD);

int sx_EMAD_ACCESS_REG_PMPD(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_PMPD);
...
int __PTASV2_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    case SXD_PTASV2_VERSION_PRODUCTS_28NM_E:
        mlxsw_reg_ptasv2_tuning_type_admin_set(inbox, ptasv2_reg->page_data.ptasv2_28nm.tuning_type_admin);
        break;

    case SXD_PTASV2_VERSION_PRODUCTS_16NM_E:
        mlxsw_reg_ptasv2_en_larger_el_buf_set(inbox, ptasv2_reg->page_data.ptasv2_16nm.en_larger_el_buf);
        break;

    case SXD_PTASV2_VERSION_PRODUCTS_7NM_E:
        mlxsw_reg_ptasv2_max_recovery_retries_en_set(inbox, ptasv2_reg->page_data.ptasv2_7nm.max_recovery_retries_en);
        mlxsw_reg_ptasv2_phy_count_linkup_delay_set(inbox, ptasv2_reg->page_data.ptasv2_7nm.phy_count_linkup_delay);
        mlxsw_reg_ptasv2_max_recovery_retries_set(inbox, ptasv2_reg->page_data.ptasv2_7nm.max_recovery_retries);
        mlxsw_reg_ptasv2_lt_tuning_admin_set(inbox, ptasv2_reg->page_data.ptasv2_7nm.lt_tuning_admin);
        mlxsw_reg_ptasv2_preset_mask_set(inbox, ptasv2_reg->page_data.ptasv2_7nm.preset_mask);
        break;
...
int __PTASV2_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    case SXD_PTASV2_VERSION_PRODUCTS_28NM_E:
        ptasv2_reg->page_data.ptasv2_28nm.tuning_type_support = mlxsw_reg_ptasv2_tuning_type_support_get(outbox);
        ptasv2_reg->page_data.ptasv2_28nm.tuning_type_admin = mlxsw_reg_ptasv2_tuning_type_admin_get(outbox);
        break;

    case SXD_PTASV2_VERSION_PRODUCTS_16NM_E:
        ptasv2_reg->page_data.ptasv2_16nm.en_larger_el_buf = mlxsw_reg_ptasv2_en_larger_el_buf_get(outbox);
        break;

    case SXD_PTASV2_VERSION_PRODUCTS_7NM_E:
        ptasv2_reg->page_data.ptasv2_7nm.max_recovery_retries_en = mlxsw_reg_ptasv2_max_recovery_retries_en_get(outbox);
        ptasv2_reg->page_data.ptasv2_7nm.phy_count_linkup_delay = mlxsw_reg_ptasv2_phy_count_linkup_delay_get(outbox);
        ptasv2_reg->page_data.ptasv2_7nm.max_recovery_retries = mlxsw_reg_ptasv2_max_recovery_retries_get(outbox);
        ptasv2_reg->page_data.ptasv2_7nm.lt_tuning_support = mlxsw_reg_ptasv2_lt_tuning_support_get(outbox);
        ptasv2_reg->page_data.ptasv2_7nm.lt_tuning_admin = mlxsw_reg_ptasv2_lt_tuning_admin_get(outbox);
        ptasv2_reg->page_data.ptasv2_7nm.preset_mask = mlxsw_reg_ptasv2_preset_mask_get(outbox);
        break;
...
int __SLSIR_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    slsir_reg->bkv_revision = mlxsw_reg_slsir_bkv_revision_get(outbox);
    slsir_reg->uphy_rev_major = mlxsw_reg_slsir_uphy_rev_major_get(outbox);
    slsir_reg->uphy_rev_minor = mlxsw_reg_slsir_uphy_rev_minor_get(outbox);
...
int __PDDR_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    case SXD_PDDR_PAGE_SELECT_OPERATIONAL_INFO_PAGE_E:
        ...
        pddr_reg->page_data.pddr_operation_info_page.rtt_measure_valid = mlxsw_reg_pddr_rtt_measure_valid_get(outbox);
        ...
        pddr_reg->page_data.pddr_operation_info_page.rtt_measured = mlxsw_reg_pddr_rtt_measured_get(outbox);
        break;
    ...
    case SXD_PDDR_PAGE_SELECT_PHY_INFO_PAGE_E:
        ...
        for (i = 0; i < SXD_PDDR_KR_STARTUP_DEBUG_INDICATIONS_NUM; i++) {
            pddr_reg->page_data.pddr_phy_info_page.kr_startup_debug_indications[i] = mlxsw_reg_pddr_kr_startup_debug_indications_get(outbox, 0, i);
        }
        pddr_reg->page_data.pddr_phy_info_page.tx_tuning_stages_lane0 = mlxsw_reg_pddr_tx_tuning_stages_lane0_get(outbox);
        pddr_reg->page_data.pddr_phy_info_page.tx_tuning_stages_lane1 = mlxsw_reg_pddr_tx_tuning_stages_lane1_get(outbox);
        pddr_reg->page_data.pddr_phy_info_page.tx_tuning_stages_lane2 = mlxsw_reg_pddr_tx_tuning_stages_lane2_get(outbox);
        pddr_reg->page_data.pddr_phy_info_page.tx_tuning_stages_lane3 = mlxsw_reg_pddr_tx_tuning_stages_lane3_get(outbox);
    ...
    case SXD_PDDR_PAGE_SELECT_MODULE_INFO_PAGE_E:
        ...
        for (i = 0; i < SXD_PDDR_VENDOR_NAME_NUM; i++) {
            pddr_reg->page_data.pddr_module_info.vendor_name[i] = mlxsw_reg_pddr_vendor_name_get(outbox, 0, i);
        }
        for (i = 0; i < SXD_PDDR_VENDOR_PN_NUM; i++) {
            pddr_reg->page_data.pddr_module_info.vendor_pn[i] = mlxsw_reg_pddr_vendor_pn_get(outbox, 0, i);
        }
        ...
        for (i = 0; i < SXD_PDDR_VENDOR_SN_NUM; i++) {
            pddr_reg->page_data.pddr_module_info.vendor_sn[i] = mlxsw_reg_pddr_vendor_sn_get(outbox, 0, i);
        }
    ...
    case SXD_PDDR_PAGE_SELECT_LINK_DOWN_INFO_E:
        ...
        pddr_reg->page_data.pddr_link_down_info_page.last_ber_mantissa = mlxsw_reg_pddr_last_ber_mantissa_get(outbox);
        pddr_reg->page_data.pddr_link_down_info_page.last_ber_exp = mlxsw_reg_pddr_last_ber_exp_get(outbox);
        pddr_reg->page_data.pddr_link_down_info_page.ber_mantissa = mlxsw_reg_pddr_ber_mantissa_get(outbox);
        pddr_reg->page_data.pddr_link_down_info_page.ber_exp = mlxsw_reg_pddr_ber_exp_get(outbox);
        pddr_reg->page_data.pddr_link_down_info_page.min_ber_mantissa = mlxsw_reg_pddr_min_ber_mantissa_get(outbox);
        pddr_reg->page_data.pddr_link_down_info_page.min_ber_exp = mlxsw_reg_pddr_min_ber_exp_get(outbox);
        pddr_reg->page_data.pddr_link_down_info_page.max_ber_mantissa = mlxsw_reg_pddr_max_ber_mantissa_get(outbox);
        pddr_reg->page_data.pddr_link_down_info_page.max_ber_exp = mlxsw_reg_pddr_max_ber_exp_get(outbox);
        pddr_reg->page_data.pddr_link_down_info_page.num_of_ber_alarams = mlxsw_reg_pddr_num_of_ber_alarams_get(outbox);
...
* PPTT
***********************************************/
int __PPTT_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_pptt_reg *pptt_reg = (struct ku_pptt_reg*)ku_reg;

    mlxsw_reg_pptt_e_set(inbox, pptt_reg->e);
    mlxsw_reg_pptt_sk_rxd_set(inbox, pptt_reg->sk_rxd);
    mlxsw_reg_pptt_p_set(inbox, pptt_reg->p);
    mlxsw_reg_pptt_dm_ig_set(inbox, pptt_reg->dm_ig);
    mlxsw_reg_pptt_sw_set(inbox, pptt_reg->sw);
    mlxsw_reg_pptt_local_port_set(inbox, pptt_reg->local_port);
    mlxsw_reg_pptt_pnat_set(inbox, pptt_reg->pnat);
    mlxsw_reg_pptt_lp_msb_set(inbox, pptt_reg->lp_msb);
    mlxsw_reg_pptt_lane_set(inbox, pptt_reg->lane);
    mlxsw_reg_pptt_port_type_set(inbox, pptt_reg->port_type);
    mlxsw_reg_pptt_le_set(inbox, pptt_reg->le);
    mlxsw_reg_pptt_prbs_mode_admin_set(inbox, pptt_reg->prbs_mode_admin);
    mlxsw_reg_pptt_vs_peer_db_set(inbox, pptt_reg->vs_peer_db);
    mlxsw_reg_pptt_modulation_set(inbox, pptt_reg->modulation);
    mlxsw_reg_pptt_lane_rate_admin_set(inbox, pptt_reg->lane_rate_admin);
    mlxsw_reg_pptt_prbs_fec_admin_set(inbox, pptt_reg->prbs_fec_admin);


    return 0;
}

int __PPTT_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_pptt_reg *pptt_reg = (struct ku_pptt_reg*)ku_reg;

    pptt_reg->e = mlxsw_reg_pptt_e_get(outbox);
    pptt_reg->sk_rxd = mlxsw_reg_pptt_sk_rxd_get(outbox);
    pptt_reg->p = mlxsw_reg_pptt_p_get(outbox);
    pptt_reg->p_c = mlxsw_reg_pptt_p_c_get(outbox);
    pptt_reg->dm_ig = mlxsw_reg_pptt_dm_ig_get(outbox);
    pptt_reg->sw = mlxsw_reg_pptt_sw_get(outbox);
    pptt_reg->sw_c = mlxsw_reg_pptt_sw_c_get(outbox);
    pptt_reg->local_port = mlxsw_reg_pptt_local_port_get(outbox);
    pptt_reg->pnat = mlxsw_reg_pptt_pnat_get(outbox);
    pptt_reg->lp_msb = mlxsw_reg_pptt_lp_msb_get(outbox);
    pptt_reg->lane = mlxsw_reg_pptt_lane_get(outbox);
    pptt_reg->port_type = mlxsw_reg_pptt_port_type_get(outbox);
    pptt_reg->ls = mlxsw_reg_pptt_ls_get(outbox);
    pptt_reg->le = mlxsw_reg_pptt_le_get(outbox);
    pptt_reg->prbs_modes_cap = mlxsw_reg_pptt_prbs_modes_cap_get(outbox);
    pptt_reg->prbs_mode_admin = mlxsw_reg_pptt_prbs_mode_admin_get(outbox);
    pptt_reg->vs_peer_db = mlxsw_reg_pptt_vs_peer_db_get(outbox);
    pptt_reg->modulation = mlxsw_reg_pptt_modulation_get(outbox);
    pptt_reg->lane_rate_cap = mlxsw_reg_pptt_lane_rate_cap_get(outbox);
    pptt_reg->prbs_fec_cap = mlxsw_reg_pptt_prbs_fec_cap_get(outbox);
    pptt_reg->lane_rate_admin = mlxsw_reg_pptt_lane_rate_admin_get(outbox);
    pptt_reg->prbs_fec_admin = mlxsw_reg_pptt_prbs_fec_admin_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__PPTT_decode);

int sx_ACCESS_REG_PPTT(struct sx_dev *dev, struct ku_access_pptt_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_PPTT_LEN >> 2) + 1;

    if (MLXSW_PPTT_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_PPTT);

int sx_EMAD_ACCESS_REG_PPTT(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_pptt_reg *reg)
{
    u16 reg_len_dword = (MLXSW_PPTT_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_PPTT);

/************************************************
* PPRT
***********************************************/
int __PPRT_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_pprt_reg *pprt_reg = (struct ku_pprt_reg*)ku_reg;

    mlxsw_reg_pprt_e_set(inbox, pprt_reg->e);
    mlxsw_reg_pprt_s_set(inbox, pprt_reg->s);
    mlxsw_reg_pprt_tun_ovr_set(inbox, pprt_reg->tun_ovr);
    mlxsw_reg_pprt_p_set(inbox, pprt_reg->p);
    mlxsw_reg_pprt_dm_ig_set(inbox, pprt_reg->dm_ig);
    mlxsw_reg_pprt_sw_set(inbox, pprt_reg->sw);
    mlxsw_reg_pprt_local_port_set(inbox, pprt_reg->local_port);
    mlxsw_reg_pprt_pnat_set(inbox, pprt_reg->pnat);
    mlxsw_reg_pprt_lp_msb_set(inbox, pprt_reg->lp_msb);
    mlxsw_reg_pprt_lane_set(inbox, pprt_reg->lane);
    mlxsw_reg_pprt_port_type_set(inbox, pprt_reg->port_type);
    mlxsw_reg_pprt_le_set(inbox, pprt_reg->le);
    mlxsw_reg_pprt_prbs_mode_admin_set(inbox, pprt_reg->prbs_mode_admin);
    mlxsw_reg_pprt_tuning_type_set(inbox, pprt_reg->tuning_type);
    mlxsw_reg_pprt_peq_dis_set(inbox, pprt_reg->peq_dis);
    mlxsw_reg_pprt_modulation_set(inbox, pprt_reg->modulation);
    mlxsw_reg_pprt_lane_rate_oper_set(inbox, pprt_reg->lane_rate_oper);
    mlxsw_reg_pprt_prbs_fec_admin_set(inbox, pprt_reg->prbs_fec_admin);
    mlxsw_reg_pprt_lt_tuning_admin_set(inbox, pprt_reg->lt_tuning_admin);
    mlxsw_reg_pprt_preset_mask_set(inbox, pprt_reg->preset_mask);


    return 0;
}

int __PPRT_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_pprt_reg *pprt_reg = (struct ku_pprt_reg*)ku_reg;

    pprt_reg->e = mlxsw_reg_pprt_e_get(outbox);
    pprt_reg->s = mlxsw_reg_pprt_s_get(outbox);
    pprt_reg->tun_ovr = mlxsw_reg_pprt_tun_ovr_get(outbox);
    pprt_reg->p = mlxsw_reg_pprt_p_get(outbox);
    pprt_reg->p_c = mlxsw_reg_pprt_p_c_get(outbox);
    pprt_reg->dm_ig = mlxsw_reg_pprt_dm_ig_get(outbox);
    pprt_reg->sw = mlxsw_reg_pprt_sw_get(outbox);
    pprt_reg->sw_c = mlxsw_reg_pprt_sw_c_get(outbox);
    pprt_reg->local_port = mlxsw_reg_pprt_local_port_get(outbox);
    pprt_reg->pnat = mlxsw_reg_pprt_pnat_get(outbox);
    pprt_reg->lp_msb = mlxsw_reg_pprt_lp_msb_get(outbox);
    pprt_reg->lane = mlxsw_reg_pprt_lane_get(outbox);
    pprt_reg->port_type = mlxsw_reg_pprt_port_type_get(outbox);
    pprt_reg->ls = mlxsw_reg_pprt_ls_get(outbox);
    pprt_reg->le = mlxsw_reg_pprt_le_get(outbox);
    pprt_reg->prbs_modes_cap = mlxsw_reg_pprt_prbs_modes_cap_get(outbox);
    pprt_reg->prbs_mode_admin = mlxsw_reg_pprt_prbs_mode_admin_get(outbox);
    pprt_reg->tuning_type = mlxsw_reg_pprt_tuning_type_get(outbox);
    pprt_reg->peq_cap = mlxsw_reg_pprt_peq_cap_get(outbox);
    pprt_reg->peq_dis = mlxsw_reg_pprt_peq_dis_get(outbox);
    pprt_reg->modulation = mlxsw_reg_pprt_modulation_get(outbox);
    pprt_reg->lane_rate_cap = mlxsw_reg_pprt_lane_rate_cap_get(outbox);
    pprt_reg->prbs_fec_cap = mlxsw_reg_pprt_prbs_fec_cap_get(outbox);
    pprt_reg->lane_rate_oper = mlxsw_reg_pprt_lane_rate_oper_get(outbox);
    pprt_reg->prbs_fec_admin = mlxsw_reg_pprt_prbs_fec_admin_get(outbox);
    pprt_reg->prbs_rx_tuning_status = mlxsw_reg_pprt_prbs_rx_tuning_status_get(outbox);
    pprt_reg->prbs_lock_status = mlxsw_reg_pprt_prbs_lock_status_get(outbox);
    pprt_reg->prbs_lock_status_ext = mlxsw_reg_pprt_prbs_lock_status_ext_get(outbox);
    pprt_reg->supported_tuning_types = mlxsw_reg_pprt_supported_tuning_types_get(outbox);
    pprt_reg->tuning_params = mlxsw_reg_pprt_tuning_params_get(outbox);
    pprt_reg->lt_tuning_support = mlxsw_reg_pprt_lt_tuning_support_get(outbox);
    pprt_reg->lt_tuning_admin = mlxsw_reg_pprt_lt_tuning_admin_get(outbox);
    pprt_reg->preset_mask = mlxsw_reg_pprt_preset_mask_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__PPRT_decode);

int sx_ACCESS_REG_PPRT(struct sx_dev *dev, struct ku_access_pprt_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_PPRT_LEN >> 2) + 1;

    if (MLXSW_PPRT_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_PPRT);

int sx_EMAD_ACCESS_REG_PPRT(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_pprt_reg *reg)
{
    u16 reg_len_dword = (MLXSW_PPRT_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_PPRT);
...
* PPRR
***********************************************/
int __PPRR_encode(u8 *inbox, void *ku_reg, void *context)
{
    struct ku_pprr_reg *pprr_reg = (struct ku_pprr_reg*)ku_reg;

    mlxsw_reg_pprr_ipv4_set(inbox, pprr_reg->ipv4);
    mlxsw_reg_pprr_ipv6_set(inbox, pprr_reg->ipv6);
    mlxsw_reg_pprr_src_set(inbox, pprr_reg->src);
    mlxsw_reg_pprr_dst_set(inbox, pprr_reg->dst);
    mlxsw_reg_pprr_tcp_set(inbox, pprr_reg->tcp);
    mlxsw_reg_pprr_udp_set(inbox, pprr_reg->udp);
    mlxsw_reg_pprr_ignore_l3_set(inbox, pprr_reg->ignore_l3);
    mlxsw_reg_pprr_ignore_l4_set(inbox, pprr_reg->ignore_l4);
    mlxsw_reg_pprr_outer_inner_set(inbox, pprr_reg->outer_inner);
    mlxsw_reg_pprr_ip_length_set(inbox, pprr_reg->ip_length);
    mlxsw_reg_pprr_register_index_set(inbox, pprr_reg->register_index);
    mlxsw_reg_pprr_port_range_min_set(inbox, pprr_reg->port_range_min);
    mlxsw_reg_pprr_port_range_max_set(inbox, pprr_reg->port_range_max);
    mlxsw_reg_pprr_comp_type_set(inbox, pprr_reg->comp_type);
    mlxsw_reg_pprr_cbset_set(inbox, pprr_reg->cbset);


    return 0;
}

int __PPRR_decode(u8 *outbox, void *ku_reg, void *context)
{
    struct ku_pprr_reg *pprr_reg = (struct ku_pprr_reg*)ku_reg;

    pprr_reg->ipv4 = mlxsw_reg_pprr_ipv4_get(outbox);
    pprr_reg->ipv6 = mlxsw_reg_pprr_ipv6_get(outbox);
    pprr_reg->src = mlxsw_reg_pprr_src_get(outbox);
    pprr_reg->dst = mlxsw_reg_pprr_dst_get(outbox);
    pprr_reg->tcp = mlxsw_reg_pprr_tcp_get(outbox);
    pprr_reg->udp = mlxsw_reg_pprr_udp_get(outbox);
    pprr_reg->ignore_l3 = mlxsw_reg_pprr_ignore_l3_get(outbox);
    pprr_reg->ignore_l4 = mlxsw_reg_pprr_ignore_l4_get(outbox);
    pprr_reg->outer_inner = mlxsw_reg_pprr_outer_inner_get(outbox);
    pprr_reg->ip_length = mlxsw_reg_pprr_ip_length_get(outbox);
    pprr_reg->register_index = mlxsw_reg_pprr_register_index_get(outbox);
    pprr_reg->port_range_min = mlxsw_reg_pprr_port_range_min_get(outbox);
    pprr_reg->port_range_max = mlxsw_reg_pprr_port_range_max_get(outbox);
    pprr_reg->comp_type = mlxsw_reg_pprr_comp_type_get(outbox);
    pprr_reg->cbset = mlxsw_reg_pprr_cbset_get(outbox);


    return 0;
}
EXPORT_SYMBOL(__PPRR_decode);

int sx_ACCESS_REG_PPRR(struct sx_dev *dev, struct ku_access_pprr_reg *reg_data)
{
    u16 reg_len_dword = (MLXSW_PPRR_LEN >> 2) + 1;

    if (MLXSW_PPRR_LEN % 4 > 0) {
        reg_len_dword++;
    }
...
EXPORT_SYMBOL(sx_ACCESS_REG_PPRR);

int sx_EMAD_ACCESS_REG_PPRR(struct sx_dev *dev,
                          emad_prio_e priority,
                          sx_emad_method_e method,
                          const struct sx_emad_in_params *in_params,
                          struct sx_emad_out_params *out_params,
                          struct ku_pprr_reg *reg)
{
    u16 reg_len_dword = (MLXSW_PPRR_LEN >> 2) + 1;
...
EXPORT_SYMBOL(sx_EMAD_ACCESS_REG_PPRR);
...
int __MPNHLFE_encode(u8 *inbox, void *ku_reg, void *context)
{
    ...
    case SXD_MPNHLFE_FORWARD_ACTION_FORWARD_TO_ETHERNET_E:
        mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_dscp_rw_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.dscp_rw);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_uecn_exp_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.uecn_exp);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_usp_dscp_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.usp_dscp);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_usp_exp_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.usp_exp);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_exp_rw_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.exp_rw);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_set_exp_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.set_exp);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_exp_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.exp);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_tqos_profile_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.tqos_profile);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_bos_check_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.bos_check);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_label_action_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.label_action);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_label_id_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.label_id);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_dmac_memcpy_to(inbox, (char *)mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.dmac);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_egress_router_interface_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.egress_router_interface);
        break;

    case SXD_MPNHLFE_FORWARD_ACTION_FORWARD_TO_IP_ROUTER_E:
        mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_dscp_rw_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.dscp_rw);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_uecn_exp_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.uecn_exp);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_usp_dscp_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.usp_dscp);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_usp_exp_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.usp_exp);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_tqos_profile_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.tqos_profile);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_irifv_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.irifv);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_irif_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.irif);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_erifv_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.erifv);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_egress_router_interface_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.egress_router_interface);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_cbset_select_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.cbset_select);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_cbset_val_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.cbset_val);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_cbset_mask_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.cbset_mask);
        break;

    case SXD_MPNHLFE_FORWARD_ACTION_CONTINUE_LOOKUPS_E:
        mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_dscp_rw_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.dscp_rw);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_uecn_exp_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.uecn_exp);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_usp_dscp_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.usp_dscp);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_usp_exp_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.usp_exp);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_tqos_profile_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.tqos_profile);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_bos_check_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.bos_check);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_irifv_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.irifv);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_irif_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.irif);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_erifv_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.erifv);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_egress_router_interface_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.egress_router_interface);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_cbset_select_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.cbset_select);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_cbset_val_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.cbset_val);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_cbset_mask_set(inbox, mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.cbset_mask);
        break;

    case SXD_MPNHLFE_FORWARD_ACTION_NEXT_NHLFE_E:
        mlxsw_reg_mpnhlfe_exp_rw_set(inbox, mpnhlfe_reg->nhlfe_parameters.next_nhlfe.exp_rw);
        mlxsw_reg_mpnhlfe_set_exp_set(inbox, mpnhlfe_reg->nhlfe_parameters.next_nhlfe.set_exp);
        mlxsw_reg_mpnhlfe_exp_set(inbox, mpnhlfe_reg->nhlfe_parameters.next_nhlfe.exp);
        mlxsw_reg_mpnhlfe_label_action_set(inbox, mpnhlfe_reg->nhlfe_parameters.next_nhlfe.label_action);
        mlxsw_reg_mpnhlfe_label_id_set(inbox, mpnhlfe_reg->nhlfe_parameters.next_nhlfe.label_id);
        mlxsw_reg_mpnhlfe_next_nhlfe_set(inbox, mpnhlfe_reg->nhlfe_parameters.next_nhlfe.next_nhlfe);
        mlxsw_reg_mpnhlfe_ecmp_size_set(inbox, mpnhlfe_reg->nhlfe_parameters.next_nhlfe.ecmp_size);
        break;
...
int __MPNHLFE_decode(u8 *outbox, void *ku_reg, void *context)
{
    ...
    switch (mpnhlfe_reg->forward_action) {
    case SXD_MPNHLFE_FORWARD_ACTION_FORWARD_TO_ETHERNET_E:
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.dscp_rw = mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_dscp_rw_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.uecn_exp = mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_uecn_exp_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.usp_dscp = mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_usp_dscp_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.usp_exp = mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_usp_exp_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.exp_rw = mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_exp_rw_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.set_exp = mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_set_exp_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.exp = mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_exp_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.tqos_profile = mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_tqos_profile_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.bos_check = mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_bos_check_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.label_action = mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_label_action_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.label_id = mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_label_id_get(outbox);
        mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_dmac_memcpy_from(outbox, (char *)mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.dmac);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_eth.egress_router_interface = mlxsw_reg_mpnhlfe_mpnhlfe_param_eth_egress_router_interface_get(outbox);
        break;

    case SXD_MPNHLFE_FORWARD_ACTION_FORWARD_TO_IP_ROUTER_E:
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.dscp_rw = mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_dscp_rw_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.uecn_exp = mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_uecn_exp_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.usp_dscp = mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_usp_dscp_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.usp_exp = mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_usp_exp_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.tqos_profile = mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_tqos_profile_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.irifv = mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_irifv_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.irif = mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_irif_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.erifv = mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_erifv_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.egress_router_interface = mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_egress_router_interface_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.cbset_select = mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_cbset_select_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.cbset_val = mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_cbset_val_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_iprouter.cbset_mask = mlxsw_reg_mpnhlfe_mpnhlfe_param_iprouter_cbset_mask_get(outbox);
        break;

    case SXD_MPNHLFE_FORWARD_ACTION_CONTINUE_LOOKUPS_E:
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.dscp_rw = mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_dscp_rw_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.uecn_exp = mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_uecn_exp_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.usp_dscp = mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_usp_dscp_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.usp_exp = mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_usp_exp_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.tqos_profile = mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_tqos_profile_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.bos_check = mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_bos_check_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.irifv = mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_irifv_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.irif = mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_irif_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.erifv = mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_erifv_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.egress_router_interface = mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_egress_router_interface_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.cbset_select = mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_cbset_select_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.cbset_val = mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_cbset_val_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.mpnhlfe_param_lookups.cbset_mask = mlxsw_reg_mpnhlfe_mpnhlfe_param_lookups_cbset_mask_get(outbox);
        break;

    case SXD_MPNHLFE_FORWARD_ACTION_NEXT_NHLFE_E:
        mpnhlfe_reg->nhlfe_parameters.next_nhlfe.exp_rw = mlxsw_reg_mpnhlfe_exp_rw_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.next_nhlfe.set_exp = mlxsw_reg_mpnhlfe_set_exp_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.next_nhlfe.exp = mlxsw_reg_mpnhlfe_exp_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.next_nhlfe.label_action = mlxsw_reg_mpnhlfe_label_action_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.next_nhlfe.label_id = mlxsw_reg_mpnhlfe_label_id_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.next_nhlfe.next_nhlfe = mlxsw_reg_mpnhlfe_next_nhlfe_get(outbox);
        mpnhlfe_reg->nhlfe_parameters.next_nhlfe.ecmp_size = mlxsw_reg_mpnhlfe_ecmp_size_get(outbox);
        break;
