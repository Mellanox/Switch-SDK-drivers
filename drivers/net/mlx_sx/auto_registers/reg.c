 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, upbt, utcam_key_id, 0x8, 0, 32, 4, 0, 4, 0);
 ...
 * Access: WO
 */
MLXSW_ITEM32_INDEXED(reg, usak, sa_key, 0x4, 0, 32, 4, 0, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, uter, entry, 0x10, 0, 32, 4, 0, 4, 0);
