 ...
 * Access: RW
 */
MLXSW_ITEM64_INDEXED(reg, hmon, wqe_overflow_rdq, 0x20, 0, 64, 8, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, mddt, register_data, 0x10, 0, 32, 4, 0);

/* command_payload_data
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, mddt, command_payload_data, 0xc, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, mddt, crspace_access_payload_data, 0x10, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, mtecr, sensor_map, 0x8, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, mtwe, sensor_warning, 0x0, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, mtewe, sensor_warning, 0x4, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, mtsde, sensor_shut_down_map, 0x4, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM64(reg, mcqi, build_time, 0x20, 0, 64);

/* user_defined_time
 * Access: RW
 */
MLXSW_ITEM64(reg, mcqi, user_defined_time, 0x28, 0, 64);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, mcda, data, 0x10, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, msgi, serial_number, 0x0, 0, 32, 4, 0);

/* part_number
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, msgi, part_number, 0x20, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, msgi, product_name, 0x40, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, mdir, device_id, 0x0, 0, 32, 4, 0);
 ...
 * Access: WO
 */
MLXSW_ITEM32_INDEXED(reg, mbct, data, 0x20, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, mocs, mocs_ppcnt_port_mask, 0x20, 0, 32, 4, 0);

/* mocs_ppcnt_grp_mask
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, mocs, mocs_ppcnt_grp_mask, 0x60, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, mocs, mocs_ppcnt_grp_prf, 0x80, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, mocs, mocs_pbsr_port_mask, 0x20, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, mocs, mocs_ceer_port_mask, 0x20, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, mocs, mocs_usacn_port_mask, 0x20, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, mocs, mocs_utcc_port_mask, 0x20, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, mocs, mocs_upcnt_port_mask, 0x20, 0, 32, 4, 0);

/* flow_estimator_record_num_rec
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, mocs, flow_estimator_record_num_rec, MLXSW_MOCS_FLOW_ESTIMATOR_RECORD_BASE_LEN + 2, 0, 11, MLXSW_MOCS_FLOW_ESTIMATOR_RECORD_REC_LEN, 0);

/* flow_estimator_record_counter_index_base
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, mocs, flow_estimator_record_counter_index_base, MLXSW_MOCS_FLOW_ESTIMATOR_RECORD_BASE_LEN, 0, 24, MLXSW_MOCS_FLOW_ESTIMATOR_RECORD_REC_LEN, 4);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, mafti, counter_index, MLXSW_MAFTI_RECORD_BASE_LEN, 0, 24, MLXSW_MAFTI_RECORD_REC_LEN, 0);

/* bytes_inc
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, mafti, bytes_inc, MLXSW_MAFTI_RECORD_BASE_LEN, 0, 32, MLXSW_MAFTI_RECORD_REC_LEN, 4);

/* packets_inc
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, mafti, packets_inc, MLXSW_MAFTI_RECORD_BASE_LEN, 0, 32, MLXSW_MAFTI_RECORD_REC_LEN, 8);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, mafbi, counter_index, MLXSW_MAFBI_RECORD_BASE_LEN, 0, 24, MLXSW_MAFBI_RECORD_REC_LEN, 0);

/* bytes_inc
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, mafbi, bytes_inc, MLXSW_MAFBI_RECORD_BASE_LEN, 0, 32, MLXSW_MAFBI_RECORD_REC_LEN, 4);

/* packets_inc
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, mafbi, packets_inc, MLXSW_MAFBI_RECORD_BASE_LEN, 0, 32, MLXSW_MAFBI_RECORD_REC_LEN, 8);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, mafri, bytes_inc, MLXSW_MAFRI_RECORD_BASE_LEN, 0, 32, MLXSW_MAFRI_RECORD_REC_LEN, 0);

/* packets_inc
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, mafri, packets_inc, MLXSW_MAFRI_RECORD_BASE_LEN, 0, 32, MLXSW_MAFRI_RECORD_REC_LEN, 4);
 ...
 * Access: RO
 */
MLXSW_ITEM8_INDEXED(reg, mopce, hw_unit_instance, MLXSW_MOPCE_PERFORMANCE_COUNTER_INFO_BASE_LEN + 1, 0, 8, MLXSW_MOPCE_PERFORMANCE_COUNTER_INFO_REC_LEN, 0);

/* hw_unit_id
 * Access: RO
 */
MLXSW_ITEM8_INDEXED(reg, mopce, hw_unit_id, MLXSW_MOPCE_PERFORMANCE_COUNTER_INFO_BASE_LEN + 3, 0, 8, MLXSW_MOPCE_PERFORMANCE_COUNTER_INFO_REC_LEN, 0);

/* counter_index
 * Access: RO
 */
MLXSW_ITEM16_INDEXED(reg, mopce, counter_index, MLXSW_MOPCE_PERFORMANCE_COUNTER_INFO_BASE_LEN, 0, 9, MLXSW_MOPCE_PERFORMANCE_COUNTER_INFO_REC_LEN, 4);

/* hw_unit_sub_instance
 * Access: RO
 */
MLXSW_ITEM8_INDEXED(reg, mopce, hw_unit_sub_instance, MLXSW_MOPCE_PERFORMANCE_COUNTER_INFO_BASE_LEN + 3, 0, 8, MLXSW_MOPCE_PERFORMANCE_COUNTER_INFO_REC_LEN, 4);

/* counter_value
 * Access: RO
 */
MLXSW_ITEM64_INDEXED(reg, mopce, counter_value, MLXSW_MOPCE_PERFORMANCE_COUNTER_INFO_BASE_LEN, 0, 64, MLXSW_MOPCE_PERFORMANCE_COUNTER_INFO_REC_LEN, 8);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, mfde, fw_assert_assert_string, 0x30, 0, 32, 4, 0);
 ...
 * Access: OP
 */
MLXSW_ITEM8_INDEXED(reg, iedr, type, MLXSW_IEDR_RECORD_BASE_LEN, 0, 8, MLXSW_IEDR_RECORD_REC_LEN, 0);

/* size
 * Access: OP
 */
MLXSW_ITEM16_INDEXED(reg, iedr, size, MLXSW_IEDR_RECORD_BASE_LEN + 2, 0, 13, MLXSW_IEDR_RECORD_REC_LEN, 0);

/* index_start
 * Access: OP
 */
MLXSW_ITEM32_INDEXED(reg, iedr, index_start, MLXSW_IEDR_RECORD_BASE_LEN, 0, 24, MLXSW_IEDR_RECORD_REC_LEN, 4);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, ifbo, outer_header_fields_enable, 0x14, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, ipac, port_mask, 0x20, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, ihsr, outer_header_fields_enable, 0x14, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, ihsr, cbsets, 0x40, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, ihscr, ports_bitmap, 0x28, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, icsr, data, 0x10, 0, 32, 4, 0);
 ...
 * Access: INDEX
 */
MLXSW_ITEM32_INDEXED(reg, sfdb_v2, key, 0x0, 0, 32, 4, 0);

/* key_mask
 * Access: INDEX
 */
MLXSW_ITEM32_INDEXED(reg, sfdb_v2, key_mask, 0x20, 0, 32, 4, 0);

/* action
 * Access: WO
 */
MLXSW_ITEM32_INDEXED(reg, sfdb_v2, action, 0x40, 0, 32, 4, 0);

/* action_mask
 * Access: WO
 */
MLXSW_ITEM32_INDEXED(reg, sfdb_v2, action_mask, 0x60, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, smid_v2, port, 0x20, 0, 32, 4, 0);

/* mask
 * Access: WO
 */
MLXSW_ITEM32_INDEXED(reg, smid_v2, mask, 0xa0, 0, 32, 4, 0);
 ...
 * Access: 
 */
MLXSW_ITEM16_INDEXED(reg, smpu, mid, 0x12, 0, 16, 0x4, 0x0);
 ...
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, spms_v2, state, MLXSW_SPMS_V2_VID_RECORD_BASE_LEN + 2, 4, 2, MLXSW_SPMS_V2_VID_RECORD_REC_LEN, 0);

/* vid
 * Access: INDEX
 */
MLXSW_ITEM16_INDEXED(reg, spms_v2, vid, MLXSW_SPMS_V2_VID_RECORD_BASE_LEN + 2, 0, 12, MLXSW_SPMS_V2_VID_RECORD_REC_LEN, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, sftr_v2, port, 0x20, 0, 32, 4, 0);

/* mask
 * Access: WO
 */
MLXSW_ITEM32_INDEXED(reg, sftr_v2, mask, 0xa0, 0, 32, 4, 0);
 ...
 * Access: OP
 */
MLXSW_ITEM8_INDEXED(reg, smpeb, update, MLXSW_SMPEB_ELPORT_RECORD_BASE_LEN, 7, 1, MLXSW_SMPEB_ELPORT_RECORD_REC_LEN, 0);

/* value
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, smpeb, value, MLXSW_SMPEB_ELPORT_RECORD_BASE_LEN, 0, 20, MLXSW_SMPEB_ELPORT_RECORD_REC_LEN, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, sfdt_v2, port_member, 0x10, 0, 16, 0x10, 0x0);
...
/* ext_eth_proto_lp_advertise
 * Access: RO
 */
MLXSW_ITEM32(reg, ptys, ext_eth_proto_lp_advertise, 0x30, 0, 32);
 ...
 * Access: RO
 */
MLXSW_ITEM8(reg, paos, lock_mode, 0x4, 0, 4);
 ...
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_rcv_codes_high, 0x8, 0, 32);

/* plr_rcv_codes_low
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_rcv_codes_low, 0xc, 0, 32);

/* plr_rcv_code_err_high
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_rcv_code_err_high, 0x10, 0, 32);

/* plr_rcv_code_err_low
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_rcv_code_err_low, 0x14, 0, 32);

/* plr_rcv_uncorrectable_code_high
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_rcv_uncorrectable_code_high, 0x18, 0, 32);

/* plr_rcv_uncorrectable_code_low
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_rcv_uncorrectable_code_low, 0x1c, 0, 32);

/* plr_xmit_codes_high
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_xmit_codes_high, 0x20, 0, 32);

/* plr_xmit_codes_low
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_xmit_codes_low, 0x24, 0, 32);

/* plr_xmit_retry_codes_high
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_xmit_retry_codes_high, 0x28, 0, 32);

/* plr_xmit_retry_codes_low
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_xmit_retry_codes_low, 0x2c, 0, 32);

/* plr_xmit_retry_events_high
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_xmit_retry_events_high, 0x30, 0, 32);

/* plr_xmit_retry_events_low
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_xmit_retry_events_low, 0x34, 0, 32);

/* plr_sync_events_high
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_sync_events_high, 0x38, 0, 32);

/* plr_sync_events_low
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_sync_events_low, 0x3c, 0, 32);

/* plr_codes_loss_high
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_codes_loss_high, 0x40, 0, 32);

/* plr_codes_loss_low
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_codes_loss_low, 0x44, 0, 32);

/* plr_xmit_retry_events_within_t_sec_max_high
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_xmit_retry_events_within_t_sec_max_high, 0x48, 0, 32);

/* plr_xmit_retry_events_within_t_sec_max_low
 * Access: RO
 */
MLXSW_ITEM32(reg, ppcnt, plr_xmit_retry_events_within_t_sec_max_low, 0x4c, 0, 32);

/* hist
 * Access: RO
 */
MLXSW_ITEM64_INDEXED(reg, ppcnt, hist, 0x8, 0, 64, 8, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, plar, local_port_allocated, 0x0, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, pmlpe, rx_lane, MLXSW_PMLPE_LANE_MODULE_MAPPING_BASE_LEN, 0, 4, MLXSW_PMLPE_LANE_MODULE_MAPPING_REC_LEN, 0);

/* tx_lane
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, pmlpe, tx_lane, MLXSW_PMLPE_LANE_MODULE_MAPPING_BASE_LEN + 1, 0, 4, MLXSW_PMLPE_LANE_MODULE_MAPPING_REC_LEN, 0);

/* slot_index
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, pmlpe, slot_index, MLXSW_PMLPE_LANE_MODULE_MAPPING_BASE_LEN + 2, 0, 4, MLXSW_PMLPE_LANE_MODULE_MAPPING_REC_LEN, 0);

/* module
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, pmlpe, module, MLXSW_PMLPE_LANE_MODULE_MAPPING_BASE_LEN + 3, 0, 8, MLXSW_PMLPE_LANE_MODULE_MAPPING_REC_LEN, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, pmsc, port_mapping_updated, 0x0, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, pmmp, sfp_cable_protocol_technology, 0x14, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM8(reg, pmcr, agc_bw_value, 0x14, 2, 6);
 ...
 * Access: RW
 */
MLXSW_ITEM16(reg, pmcr, agc_target_value, 0x18, 4, 9);
 ...
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, sltp, inner_eye, 0x10, 0, 16, 2, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM8(reg, slsir, uphy_rev_subminor, 0x1c, 0, 4);

/* bkv_revision_cln
 * Access: RO
 */
MLXSW_ITEM8(reg, slsir, bkv_revision_cln, 0x1d, 0, 8);

/* bkv_revision_rx
 * Access: RO
 */
MLXSW_ITEM8(reg, slsir, bkv_revision_rx, 0x1e, 0, 8);

/* uphy_rev_major
 * Access: RO
 */
MLXSW_ITEM8(reg, slsir, uphy_rev_major, 0x1f, 4, 4);

/* uphy_rev_minor
 * Access: RO
 */
MLXSW_ITEM8(reg, slsir, uphy_rev_minor, 0x1f, 0, 4);
 ...
 * Access: RO
 */
MLXSW_ITEM8(reg, pddr, rtt_measure_valid, 0x2a, 0, 1);
 ...
 * Access: RO
 */
MLXSW_ITEM32(reg, pddr, rtt_measured, 0x40, 0, 32);
 ...
 * Access: RO
 */
MLXSW_ITEM_BUF(reg, pddr, kr_startup_fsm_lane, 0x50, 4);
...
/* kr_startup_debug_indications
 * Access: RO
 */
MLXSW_ITEM16_INDEXED(reg, pddr, kr_startup_debug_indications, 0x60, 0, 16, 2, 0);

/* tx_tuning_stages_lane0
 * Access: RO
 */
MLXSW_ITEM8(reg, pddr, tx_tuning_stages_lane0, 0x68, 4, 4);

/* tx_tuning_stages_lane1
 * Access: RO
 */
MLXSW_ITEM8(reg, pddr, tx_tuning_stages_lane1, 0x68, 0, 4);

/* tx_tuning_stages_lane2
 * Access: RO
 */
MLXSW_ITEM8(reg, pddr, tx_tuning_stages_lane2, 0x69, 4, 4);

/* tx_tuning_stages_lane3
 * Access: RO
 */
MLXSW_ITEM8(reg, pddr, tx_tuning_stages_lane3, 0x69, 0, 4);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, pddr, vendor_name, 0x1c, 0, 32, 4, 0);

/* vendor_pn
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, pddr, vendor_pn, 0x2c, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, pddr, vendor_sn, 0x44, 0, 32, 4, 0);
 ...
 * Access: OP
 */
MLXSW_ITEM32_INDEXED(reg, pddr, pddr_port_events_page_layout_clr_mask, 0x28, 0, 32, 4, 0);
 ...
 * Access: OP
 */
MLXSW_ITEM32_INDEXED(reg, pddr, pddr_device_events_page_clr_mask, 0x28, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM8(reg, pddr, last_ber_mantissa, 0x18, 0, 4);

/* last_ber_exp
 * Access: RO
 */
MLXSW_ITEM8(reg, pddr, last_ber_exp, 0x19, 0, 8);

/* ber_mantissa
 * Access: RO
 */
MLXSW_ITEM8(reg, pddr, ber_mantissa, 0x1a, 0, 4);

/* ber_exp
 * Access: RO
 */
MLXSW_ITEM8(reg, pddr, ber_exp, 0x1b, 0, 8);

/* min_ber_mantissa
 * Access: RO
 */
MLXSW_ITEM8(reg, pddr, min_ber_mantissa, 0x1c, 0, 4);

/* min_ber_exp
 * Access: RO
 */
MLXSW_ITEM8(reg, pddr, min_ber_exp, 0x1d, 0, 8);

/* max_ber_mantissa
 * Access: RO
 */
MLXSW_ITEM8(reg, pddr, max_ber_mantissa, 0x1e, 0, 4);

/* max_ber_exp
 * Access: RO
 */
MLXSW_ITEM8(reg, pddr, max_ber_exp, 0x1f, 0, 8);

/* num_of_ber_alarams
 * Access: RO
 */
MLXSW_ITEM16(reg, pddr, num_of_ber_alarams, 0x22, 0, 16);
 ...
 * Access: INDEX
 */
MLXSW_ITEM16(reg, pddr, pport, 0x8, 6, 8);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, pddr, max_time_isr, 0x10, 0, 32, 4, 0);

/* buff_sel
 * Access: INDEX
 */
MLXSW_ITEM8(reg, pddr, buff_sel, 0xb, 0, 2);

/* array512_auto
 * Access: 
 */
MLXSW_ITEM32_INDEXED(reg, pddr, array512_auto, 0xc, 0, 32, 0x40, 0x0);
 ...
 * Access: RW
 */
MLXSW_ITEM8(reg, pptt, sk_rxd, 0x0, 6, 1);
 ...
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, pphcr, high_val, MLXSW_PPHCR_BIN_RANGE_BASE_LEN + 1, 0, 4, MLXSW_PPHCR_BIN_RANGE_REC_LEN, 0);

/* low_val
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, pphcr, low_val, MLXSW_PPHCR_BIN_RANGE_BASE_LEN + 3, 0, 4, MLXSW_PPHCR_BIN_RANGE_REC_LEN, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, pcsr, port_status_mask, 0x4, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, pifr_v2, port_filter, 0x20, 0, 32, 4, 0);

/* port_filter_update_en
 * Access: WO
 */
MLXSW_ITEM32_INDEXED(reg, pifr_v2, port_filter_update_en, 0xa0, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM16_INDEXED(reg, pbsr, stat_buffer_watermark, MLXSW_PBSR_STAT_BUFFER_BASE_LEN + 2, 0, 16, MLXSW_PBSR_STAT_BUFFER_REC_LEN, 0);

/* stat_buffer_used_buffer
 * Access: RO
 */
MLXSW_ITEM16_INDEXED(reg, pbsr, stat_buffer_used_buffer, MLXSW_PBSR_STAT_BUFFER_BASE_LEN + 2, 0, 16, MLXSW_PBSR_STAT_BUFFER_REC_LEN, 4);
 ...
 * Access: RW
 */
MLXSW_ITEM8(reg, ppcr, num_of_planes, 0xf, 0, 3);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, sbsrd, buff_occupancy, MLXSW_SBSRD_SHARED_BUFFER_STATUS_BASE_LEN, 0, 24, MLXSW_SBSRD_SHARED_BUFFER_STATUS_REC_LEN, 0);

/* max_buff_occupancy
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, sbsrd, max_buff_occupancy, MLXSW_SBSRD_SHARED_BUFFER_STATUS_BASE_LEN, 0, 24, MLXSW_SBSRD_SHARED_BUFFER_STATUS_REC_LEN, 4);

/* ext_buff_occupancy
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, sbsrd, ext_buff_occupancy, 0x410, 0, 24, 0x4, 0x0);
 ...
 * Access: RO
 */
MLXSW_ITEM64_INDEXED(reg, sbhrr_v2, bin, 0x40, 0, 64, 8, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, perb, perb_classifier_iport_ingress_local_port_list, 0x60, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, ptcead, activity_vector, 0x20, 0, 32, 4, 0);
 ...
 * Access: 
 */
MLXSW_ITEM32_INDEXED(reg, pefaad, index_dump, 0x20, 0, 24, 0x4, 0x0);
 ...
 * Access: INDEX
 */
MLXSW_ITEM32_INDEXED(reg, peapbm, key, 0x20, 0, 32, 4, 0);

/* key_mask
 * Access: INDEX
 */
MLXSW_ITEM32_INDEXED(reg, peapbm, key_mask, 0x80, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, cedr, detection_table, 0x10, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, ceer, sip, 0x40, 0, 32, 4, 0);

/* dip
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, ceer, dip, 0x50, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, ceer, inner_sip, 0x80, 0, 32, 4, 0);

/* inner_dip
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, ceer, inner_dip, 0x90, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, rigr_v2, v, MLXSW_RIGR_V2_ERIF_ENTRY_BASE_LEN, 7, 1, MLXSW_RIGR_V2_ERIF_ENTRY_REC_LEN, 0);

/* erif
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, rigr_v2, erif, MLXSW_RIGR_V2_ERIF_ENTRY_BASE_LEN + 2, 0, 16, MLXSW_RIGR_V2_ERIF_ENTRY_REC_LEN, 0);

/* adabe_reserved
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, rigr_v2, adabe_reserved, 0xa4, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, rmftad, activity_vector, 0x20, 0, 32, 4, 0);
 ...
 * Access: WO
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, type, MLXSW_RATRB_RECORD_BASE_LEN, 4, 4, MLXSW_RATRB_RECORD_REC_LEN, 0);

/* size
 * Access: WO
 */
MLXSW_ITEM16_INDEXED(reg, ratrb, size, MLXSW_RATRB_RECORD_BASE_LEN, 0, 12, MLXSW_RATRB_RECORD_REC_LEN, 0);

/* egress_router_interface
 * Access: WO
 */
MLXSW_ITEM16_INDEXED(reg, ratrb, egress_router_interface, MLXSW_RATRB_RECORD_BASE_LEN + 2, 0, 16, MLXSW_RATRB_RECORD_REC_LEN, 0);

/* counter_set_type
 * Access: WO
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, counter_set_type, MLXSW_RATRB_RECORD_BASE_LEN, 0, 8, MLXSW_RATRB_RECORD_REC_LEN, 4);

/* counter_index
 * Access: WO
 */
MLXSW_ITEM32_INDEXED(reg, ratrb, counter_index, MLXSW_RATRB_RECORD_BASE_LEN, 0, 24, MLXSW_RATRB_RECORD_REC_LEN, 4);

/* destination_mac
 * Access: RW
 */
MLXSW_ITEM_BUF_INDEXED(reg, ratrb, destination_mac, MLXSW_RATRB_RECORD_BASE_LEN, 0x6, 0x20, 10);

/* mpls_adjacency_nhlfe_ptr
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, ratrb, mpls_adjacency_nhlfe_ptr, MLXSW_RATRB_RECORD_BASE_LEN, 0, 24, MLXSW_RATRB_RECORD_REC_LEN, 8);

/* mpls_adjacency_tqos_profile
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, mpls_adjacency_tqos_profile, MLXSW_RATRB_RECORD_BASE_LEN, 0, 4, MLXSW_RATRB_RECORD_REC_LEN, 12);

/* mpls_adjacency_ecmp_size
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, ratrb, mpls_adjacency_ecmp_size, MLXSW_RATRB_RECORD_BASE_LEN + 2, 0, 13, MLXSW_RATRB_RECORD_REC_LEN, 12);

/* mpls_adjacency_underlay_router_interface
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, ratrb, mpls_adjacency_underlay_router_interface, MLXSW_RATRB_RECORD_BASE_LEN + 2, 0, 16, MLXSW_RATRB_RECORD_REC_LEN, 24);

/* ipinip_encap_adjacency_ipip_type
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, ipinip_encap_adjacency_ipip_type, MLXSW_RATRB_RECORD_BASE_LEN + 1, 0, 4, MLXSW_RATRB_RECORD_REC_LEN, 8);

/* ipinip_encap_adjacency_tqos_profile_en
 * Access: OP
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, ipinip_encap_adjacency_tqos_profile_en, MLXSW_RATRB_RECORD_BASE_LEN, 7, 1, MLXSW_RATRB_RECORD_REC_LEN, 12);

/* ipinip_encap_adjacency_tqos_profile
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, ipinip_encap_adjacency_tqos_profile, MLXSW_RATRB_RECORD_BASE_LEN, 0, 4, MLXSW_RATRB_RECORD_REC_LEN, 12);

/* ipinip_encap_adjacency_uirif_v
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, ipinip_encap_adjacency_uirif_v, MLXSW_RATRB_RECORD_BASE_LEN + 1, 0, 1, MLXSW_RATRB_RECORD_REC_LEN, 12);

/* ipinip_encap_adjacency_uirif
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, ratrb, ipinip_encap_adjacency_uirif, MLXSW_RATRB_RECORD_BASE_LEN + 2, 0, 16, MLXSW_RATRB_RECORD_REC_LEN, 12);

/* ipinip_encap_adjacency_ipv4_udip
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, ratrb, ipinip_encap_adjacency_ipv4_udip, MLXSW_RATRB_RECORD_BASE_LEN, 0, 32, MLXSW_RATRB_RECORD_REC_LEN, 16);

/* ipinip_encap_adjacency_ipv6_ptr
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, ratrb, ipinip_encap_adjacency_ipv6_ptr, MLXSW_RATRB_RECORD_BASE_LEN, 0, 24, MLXSW_RATRB_RECORD_REC_LEN, 20);

/* l3_generic_encap_adjacency_u_ip_ver
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, l3_generic_encap_adjacency_u_ip_ver, MLXSW_RATRB_RECORD_BASE_LEN + 1, 0, 4, MLXSW_RATRB_RECORD_REC_LEN, 8);

/* l3_generic_encap_adjacency_emt_pointer
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, l3_generic_encap_adjacency_emt_pointer, MLXSW_RATRB_RECORD_BASE_LEN + 3, 0, 8, MLXSW_RATRB_RECORD_REC_LEN, 8);

/* l3_generic_encap_adjacency_tqos_profile
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, l3_generic_encap_adjacency_tqos_profile, MLXSW_RATRB_RECORD_BASE_LEN, 0, 4, MLXSW_RATRB_RECORD_REC_LEN, 12);

/* l3_generic_encap_adjacency_uirif
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, ratrb, l3_generic_encap_adjacency_uirif, MLXSW_RATRB_RECORD_BASE_LEN + 2, 0, 16, MLXSW_RATRB_RECORD_REC_LEN, 12);

/* l3_generic_encap_adjacency_ipv4_udip
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, ratrb, l3_generic_encap_adjacency_ipv4_udip, MLXSW_RATRB_RECORD_BASE_LEN, 0, 32, MLXSW_RATRB_RECORD_REC_LEN, 16);

/* l3_generic_encap_adjacency_ipv6_ptr
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, ratrb, l3_generic_encap_adjacency_ipv6_ptr, MLXSW_RATRB_RECORD_BASE_LEN, 0, 24, MLXSW_RATRB_RECORD_REC_LEN, 20);

/* l3_generic_encap_adjacency_cbset_x_select
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, l3_generic_encap_adjacency_cbset_x_select, MLXSW_RATRB_RECORD_BASE_LEN, 0, 3, MLXSW_RATRB_RECORD_REC_LEN, 24);

/* l3_generic_encap_adjacency_cbset_y_select
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, l3_generic_encap_adjacency_cbset_y_select, MLXSW_RATRB_RECORD_BASE_LEN + 1, 0, 3, MLXSW_RATRB_RECORD_REC_LEN, 24);

/* l3_generic_encap_adjacency_cbset_x_set_en
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, l3_generic_encap_adjacency_cbset_x_set_en, MLXSW_RATRB_RECORD_BASE_LEN + 3, 1, 1, MLXSW_RATRB_RECORD_REC_LEN, 24);

/* l3_generic_encap_adjacency_cbset_y_set_en
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, l3_generic_encap_adjacency_cbset_y_set_en, MLXSW_RATRB_RECORD_BASE_LEN + 3, 0, 1, MLXSW_RATRB_RECORD_REC_LEN, 24);

/* l3_generic_encap_adjacency_cbset_x_val
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, ratrb, l3_generic_encap_adjacency_cbset_x_val, MLXSW_RATRB_RECORD_BASE_LEN, 0, 16, MLXSW_RATRB_RECORD_REC_LEN, 28);

/* l3_generic_encap_adjacency_cbset_y_val
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, ratrb, l3_generic_encap_adjacency_cbset_y_val, MLXSW_RATRB_RECORD_BASE_LEN + 2, 0, 16, MLXSW_RATRB_RECORD_REC_LEN, 28);

/* new_header_type
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, new_header_type, MLXSW_RATRB_RECORD_BASE_LEN, 0, 4, MLXSW_RATRB_RECORD_REC_LEN, 8);

/* irif
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, ratrb, irif, MLXSW_RATRB_RECORD_BASE_LEN + 2, 0, 16, MLXSW_RATRB_RECORD_REC_LEN, 8);

/* qos_profile
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, qos_profile, MLXSW_RATRB_RECORD_BASE_LEN, 0, 4, MLXSW_RATRB_RECORD_REC_LEN, 12);

/* new_ipv4_udip
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, ratrb, new_ipv4_udip, MLXSW_RATRB_RECORD_BASE_LEN, 0, 32, MLXSW_RATRB_RECORD_REC_LEN, 16);

/* new_ipv6_ptr
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, ratrb, new_ipv6_ptr, MLXSW_RATRB_RECORD_BASE_LEN, 0, 24, MLXSW_RATRB_RECORD_REC_LEN, 20);

/* exp_l3
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, exp_l3, MLXSW_RATRB_RECORD_BASE_LEN + 3, 0, 2, MLXSW_RATRB_RECORD_REC_LEN, 24);

/* relookup_ecmp_adjacency_next_adjacency_ptr
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, ratrb, relookup_ecmp_adjacency_next_adjacency_ptr, MLXSW_RATRB_RECORD_BASE_LEN, 0, 24, MLXSW_RATRB_RECORD_REC_LEN, 8);

/* relookup_ecmp_adjacency_next_ecmp_size
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, ratrb, relookup_ecmp_adjacency_next_ecmp_size, MLXSW_RATRB_RECORD_BASE_LEN + 2, 0, 13, MLXSW_RATRB_RECORD_REC_LEN, 12);

/* relookup_ecmp_adjacency_rd
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, relookup_ecmp_adjacency_rd, MLXSW_RATRB_RECORD_BASE_LEN + 1, 0, 1, MLXSW_RATRB_RECORD_REC_LEN, 16);

/* relookup_ecmp_adjacency_rehash_seed
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, ratrb, relookup_ecmp_adjacency_rehash_seed, MLXSW_RATRB_RECORD_BASE_LEN + 2, 0, 16, MLXSW_RATRB_RECORD_REC_LEN, 16);

/* relookup_lpm_adjacency_virtual_router
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, ratrb, relookup_lpm_adjacency_virtual_router, MLXSW_RATRB_RECORD_BASE_LEN + 2, 0, 16, MLXSW_RATRB_RECORD_REC_LEN, 8);

/* relookup_lpm_adjacency_rd
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, ratrb, relookup_lpm_adjacency_rd, MLXSW_RATRB_RECORD_BASE_LEN + 1, 0, 1, MLXSW_RATRB_RECORD_REC_LEN, 16);

/* relookup_lpm_adjacency_rehash_seed
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, ratrb, relookup_lpm_adjacency_rehash_seed, MLXSW_RATRB_RECORD_BASE_LEN + 2, 0, 16, MLXSW_RATRB_RECORD_REC_LEN, 16);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, rips, ipv6, 0x4, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, ralst, bin, 0x4, 0, 16, 2, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, rmid_v2, egress_port, 0x20, 0, 32, 4, 0);
 ...
 * Access: OP
 */
MLXSW_ITEM8_INDEXED(reg, reiv, update, MLXSW_REIV_ELPORT_RECORD_BASE_LEN, 7, 1, MLXSW_REIV_ELPORT_RECORD_REC_LEN, 0);

/* evid
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, reiv, evid, MLXSW_REIV_ELPORT_RECORD_BASE_LEN + 2, 0, 12, MLXSW_REIV_ELPORT_RECORD_REC_LEN, 0);
 ...
 * Access: INDEX
 */
MLXSW_ITEM32_INDEXED(reg, rlcme, dip, 0xc, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, rlcme, action, 0x20, 0, 32, 4, 0);
 ...
 * Access: INDEX
 */
MLXSW_ITEM32_INDEXED(reg, rlcmle, dip, 0xc, 0, 32, 4, 0);
 ...
 * Access: INDEX
 */
MLXSW_ITEM32_INDEXED(reg, rlcmld, dip, 0x10, 0, 32, 4, 0);

/* dip_mask
 * Access: INDEX
 */
MLXSW_ITEM32_INDEXED(reg, rlcmld, dip_mask, 0x20, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, rarpc, ingress_port, 0x30, 0, 32, 4, 0);

/* port_range_min
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, rarpc, port_range_min, MLXSW_RARPC_L4PORT_CMP_BASE_LEN, 0, 16, MLXSW_RARPC_L4PORT_CMP_REC_LEN, 0);

/* port_range_max
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, rarpc, port_range_max, MLXSW_RARPC_L4PORT_CMP_BASE_LEN + 2, 0, 16, MLXSW_RARPC_L4PORT_CMP_REC_LEN, 0);

/* port_src
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, rarpc, port_src, MLXSW_RARPC_L4PORT_CMP_BASE_LEN + 3, 4, 1, MLXSW_RARPC_L4PORT_CMP_REC_LEN, 4);

/* comp_field
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, rarpc, comp_field, MLXSW_RARPC_L4PORT_CMP_BASE_LEN + 3, 0, 2, MLXSW_RARPC_L4PORT_CMP_REC_LEN, 4);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, rarlpgt, egress_port, 0x20, 0, 32, 4, 0);

/* egress_port_or
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, rarlpgt, egress_port_or, 0xa0, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM8_INDEXED(reg, rirt, valid, MLXSW_RIRT_ROUTER_ENTRY_RECORD_BASE_LEN, 7, 1, MLXSW_RIRT_ROUTER_ENTRY_RECORD_REC_LEN, 0);

/* swid
 * Access: RO
 */
MLXSW_ITEM8_INDEXED(reg, rirt, swid, MLXSW_RIRT_ROUTER_ENTRY_RECORD_BASE_LEN + 3, 0, 3, MLXSW_RIRT_ROUTER_ENTRY_RECORD_REC_LEN, 0);

/* subnet_prefix
 * Access: RO
 */
MLXSW_ITEM16_INDEXED(reg, rirt, subnet_prefix, MLXSW_RIRT_ROUTER_ENTRY_RECORD_BASE_LEN + 2, 0, 16, MLXSW_RIRT_ROUTER_ENTRY_RECORD_REC_LEN, 4);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, tnumt, tunnel_mc_ipv4_udip, 0xc, 0, 32, 4, 0);
 ...
 * Access: 
 */
MLXSW_ITEM32_INDEXED(reg, tnumt, tunnel_mc_ipv6_udip_ptr, 0xc, 0, 24, 0x4, 0x0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, tngcr, usipv6, 0x30, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, tnifr, port_filter, 0x20, 0, 32, 4, 0);

/* port_filter_update_en
 * Access: OP
 */
MLXSW_ITEM32_INDEXED(reg, tnifr, port_filter_update_en, 0x40, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, tnifr_v2, port_filter, 0x20, 0, 32, 4, 0);

/* port_filter_update_en
 * Access: OP
 */
MLXSW_ITEM32_INDEXED(reg, tnifr_v2, port_filter_update_en, 0xa0, 0, 32, 4, 0);
 ...
 * Access: INDEX
 */
MLXSW_ITEM32_INDEXED(reg, fpums, port_mask, 0x10, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM8_INDEXED(reg, fstm, ticket_machine_en, MLXSW_FSTM_PORT_TICKET_INFO_BASE_LEN + 2, 7, 1, MLXSW_FSTM_PORT_TICKET_INFO_REC_LEN, 0);

/* lport
 * Access: WO
 */
MLXSW_ITEM16_INDEXED(reg, fstm, lport, MLXSW_FSTM_PORT_TICKET_INFO_BASE_LEN + 2, 0, 10, MLXSW_FSTM_PORT_TICKET_INFO_REC_LEN, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, fsfh, action_info, 0x4, 0, 32, 4, 0);
 ...
 * Access: WO
 */
MLXSW_ITEM32_INDEXED(reg, xmdr, transaction, 0x20, 0, 32, 4, 0);
 ...
 * Access: OP
 */
MLXSW_ITEM32_INDEXED(reg, xlkbu, value, 0x40, 0, 32, 4, 0);

/* mask
 * Access: OP
 */
MLXSW_ITEM32_INDEXED(reg, xlkbu, mask, 0x80, 0, 32, 4, 0);

/* new_value
 * Access: OP
 */
MLXSW_ITEM32_INDEXED(reg, xlkbu, new_value, 0xc0, 0, 32, 4, 0);

/* new_value_mask
 * Access: OP
 */
MLXSW_ITEM32_INDEXED(reg, xlkbu, new_value_mask, 0x100, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM16_INDEXED(reg, xralst, bin, 0x8, 0, 16, 2, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, upbt, utcam_key_id, 0x8, 0, 32, 4, 0);
 ...
 * Access: WO
 */
MLXSW_ITEM32_INDEXED(reg, usak, sa_key, 0x4, 0, 32, 4, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM64_INDEXED(reg, utcc, counter, 0x8, 0, 64, 8, 0);
 ...
 * Access: RO
 */
MLXSW_ITEM32_INDEXED(reg, utfd, data, 0x20, 0, 32, 4, 0);
 ...
 * Access: RW
 */
MLXSW_ITEM32_INDEXED(reg, uter, entry, 0x10, 0, 32, 4, 0);
