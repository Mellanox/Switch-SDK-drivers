...
SX_CORE_IOCTL_ACCESS_REG_HANDLER(PMPT, ku_access_pmpt_reg);
SX_CORE_IOCTL_ACCESS_REG_HANDLER(PMPD, ku_access_pmpd_reg);
...
SX_CORE_IOCTL_ACCESS_REG_HANDLER(PPTT, ku_access_pptt_reg);
SX_CORE_IOCTL_ACCESS_REG_HANDLER(PPRT, ku_access_pprt_reg);
...
SX_CORE_IOCTL_ACCESS_REG_HANDLER(PPRR, ku_access_pprr_reg);
...
ioctl_auto_reg_handler_table[CTRL_CMD_ACCESS_REG_MAX - CTRL_CMD_ACCESS_REG_MIN + 1] = {
    ...
    IOCTL_REG_HANDLER(PMPT),
    IOCTL_REG_HANDLER(PMPD),
    ...
    IOCTL_REG_HANDLER(PPTT),
    IOCTL_REG_HANDLER(PPRT),
