...
int __init sx_core_counters_init(void)
{
    ...
    sx_dbg_dump_read_handler_register("counters_active_since_show",
                                      ...
                                      __counters_seq_file_size, NULL);
    sx_dbg_dump_read_handler_register("clear_counters", proc_clear_counters, NULL, NULL);
...
{
    sx_dbg_dump_read_handler_unregister("counters");
    sx_dbg_dump_read_handler_unregister("counters_active_since_startup");
    sx_dbg_dump_read_handler_unregister("counters_active_since_clear");
    sx_dbg_dump_read_handler_unregister("counters_active_since_show");
    sx_dbg_dump_read_handler_unregister("clear_counters");
}
