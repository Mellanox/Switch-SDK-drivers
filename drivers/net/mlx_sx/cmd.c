...
/* calculate how many cmd_ifc iteration allowed without ACK from HW,
 * every iteration take periodic_time , max time without ACK is SX_CMD_TIME_CLASS_A   */
u32 sx_cmd_calc_num_of_check_iter(u32 periodic_time)
{
    return ((SX_CMD_TIME_CLASS_A / (periodic_time * 1000)) + 1);
}
