...
struct dev_specific_cb {
    ...
    int (*sx_ptp_dump)(struct sx_priv *priv, struct seq_file *m, void *v);
    ...
    int (*sx_clock_dump)(struct sx_priv *priv, struct seq_file *m, void *v);
...
struct sx_priv {
    ...
    struct {
        ...
        struct sx_clock_log_db log_settime;
        struct sx_clock_log_db log_adjtime;
        struct sx_clock_log_db log_adjfreq;
        struct sx_clock_log_db log_activity;
        union {
            struct {
    ...
    struct {
        ...
        union {
            struct {
                ...
                struct sx_clock_log_db log_errors;  /* log of error events */
                struct ptp_db          rx_db;
                struct ptp_db          tx_db;
            ...
            struct {
                ...
                struct sx_clock_log_db log_rx;
                struct sx_clock_log_db log_tx;
            } spc2; /* and SPC3 */
        } hwd;
    } ptp;
...
struct sx_globals {
    ...
    struct sx_dev           *fake_dev;           /* running on a VM (NO_PCI is defined) or on OOB systems */
